...
if(top.window.location.hostname.includes('cyclismactu.net')){
    // top.ga('smile_corner_video.send', 'event', 'Quality Traffic', 'cyclismactu_net_9b6a646', 'Same domain');
}else{
    // top.ga('smile_corner_video.send', 'event', 'Quality Traffic', 'cyclismactu_net_9b6a646', 'Not same domain');
    top.ga('smile_corner_video.send', 'event', 'Not same domain', 'cyclismactu_net_9b6a646', top.window.location.hostname);
}


top.ga('smile_corner_video.send', 'pageview');
top.ga('smile_corner_video.send', 'event', 'Source Traffic', 'cyclismactu_net_9b6a646', 'corner-video');
