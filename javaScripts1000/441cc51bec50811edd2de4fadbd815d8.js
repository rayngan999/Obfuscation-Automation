    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'97238746e9c84fab9d06f9cbc803f396',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_978327971557');
                if (frame) {
...
;np764531("97238746e9c84fab9d06f9cbc803f396",false);


try{__tagObject_callback_978327971557({ImpressionID:"97238746e9c84fab9d06f9cbc803f396", ServerPublicDns:"tps812.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "97238746e9c84fab9d06f9cbc803f396");}catch(e){}
try{__verify_callback_978327971557({
ResultID:2,
Passback:"",
AdWidth:300,
AdHeight:250});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "97238746e9c84fab9d06f9cbc803f396");}catch(e){}
