$(function () {
    ...
    var WorkControlSlideAuto = setInterval(WorkControlSlideGO, parseInt(WorkControlSlideSeccont) * 2000);
    ...
    $('.wc_slide_pager').mouseenter(function () {
      ...
      WorkControlSlideAuto = setInterval(WorkControlSlideGO, WorkControlSlideSeccont * 2000);
    });
});
