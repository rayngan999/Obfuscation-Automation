...
ClickTaleGlobal.scripts.versions = {"wr": "latest-WR110.js", "pcc": "c3a7a785-dd4d-4f95-aecd-e92be0b093ea.js?DeploymentConfigName=Release_20201111&Version=1"};
(function (d) {
	var dom="h",
	...
	ClickTaleGlobal.init.isAllowed = (function() {
						var doms = ["kPNPaHsuLPucLZaVcHuPLhZR","kVTHuHRBqLThZR","kVTHuHRBwBqLThZR","kVZaBwuFkVTVchZR","LyZaLAHThZR","LyZaLNyVBwPahJVT","LyZaLwyPcHaLiHuRPuNhZR","THTuHaVhZR","ZsZwhZR","ZsZwHBaVhZR","ZsZwoFwVaLRHhZR","BJLahZR","gHwsHaTViPsVThZR"];
...
;
(function () {
    var selectorForBoth = '.dk-selected, .dk-option, .gem-select__single-value';
...
if(!ClickTaleGlobal.init.pccRequested) {
	    ...
	    pccSrc += 'c3a7a785-dd4d-4f95-aecd-e92be0b093ea.js?DeploymentConfigName=Release_20201111&Version=1';
...
window.ClickTaleSettings.PTC.CustomVariables = [
    ...
    { displayName: 'Page Title', key: 'pageTitle', slot: 2 },
    { displayName: 'Page Template', key: 'pageTemplate', slot: 3 },
    { displayName: 'Language', key: 'language', slot: 4 }
];

function sendCVar() {
    //IMP-467
    var data = document.querySelector('#gem-settings');
    data = !!data && !!data.innerText && JSON.parse(data.innerText);
    if (!!data) {
        var cVars = window.ClickTaleSettings.PTC.CustomVariables;
        for (i = 0; i < cVars.length; i++) {
            if (!!data[cVars[i].key]) {
                window._uxa.push(['setCustomVariable', cVars[i].slot, cVars[i].displayName, data[cVars[i].key]]);
            }
        }
    }
}
...
//Signature:BjFYKSp6BwTBsgqr+wJ0cpYEbjdiXJJ/Kz4bzgANdMZaXmmwEp0AQrCz4ICrKi4qv8tauJf8P8L8i4l9CVkU4svNLby925v3PB1CxchXto/wiuNWZs578Y+wetJ3UgPtoa23liFTglbSYrVXvr7e4IdPfZ/RYkiQxBpaBAWj+Uw=