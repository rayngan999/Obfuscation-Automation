...
<div id="b-navbar-fg">
<table id="b-navbar-controls" cellpadding="0" cellspacing="0" border="0" width="100%"><tr style="height:20px"><td valign="middle" width="24px"><a href="https://www.blogger.com/" id="b-navbar-logo" tabindex="1" title="åå¾ Blogger.com"></a>
<div id="b-sms" class="b-mobile"><a href="sms:?body=%E6%82%A8%E5%A5%BD%EF%BC%8C%E5%BF%AB%E5%88%B0+https://lightdlmovies.blogspot.com/%3Fspref%3Dsms+%E6%9F%A5%E7%9C%8B+LIGHT+DOWNLOADS" tabindex="2">ä»¥ç­è¨ç¼é</a></div></td>
<td valign="middle" width="150px"><form id="searchthis" action="https://lightdlmovies.blogspot.com/search" method="get" style="display:inline;"><div id="b-query-box"><table cellpadding="0" cellspacing="0"><td valign="middle"><input type="text" id="b-query" name="q" tabindex="3" style="width: 120px" title="æå°"></td>
<td valign="middle" style="width:15px"><a id="b-query-icon" onclick="document.getElementById(&quot;searchthis&quot;).submit();" title="æå°æ­¤ç¶²èª"></a></td></table></div>
</form></td>
<td valign="middle" nowrap class="gplus">


<a id="b-more" class="b-link" tabindex="4" onclick="var anchor = this; if (anchor.__m) { anchor.__m.restyle({show: true}); } else if (!this.__mi) { this.__mi = true; gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() { gapi.iframes.getContext().open( { url: &quot;navbar-more.g?data\x3dAPq4FmC50h0N3j6huub1WPwjdNQpO64Dy0uIic1bi9AJCOt_2BbKTM5UfH4DFvcfsqvYrDyLPnTAtlQ8X8xPo2QysfcR5ioWiz4b8m686KOFXKy_jV2PISEDSWI8IA-Dcix3hgUPKHg-eWTN-yaAwMlLQIMgHV8pl71Bu_mR2D_WFJqPTuwYyNEdRGQ1LdqQV7w-JqJ1I-OZmR16jwnVWRqQOzpdjo3TVDd6fPpLLO2ynMqRbLsyYr4MHPcSonMa7BhqC5Vwsfxs&quot;, id: &#39;more-iframe&#39;, style: &#39;bubble&#39;, bubbletype: &#39;pls-default&#39;, arrowPosition: &#39;center&#39;, anchorPosition: &#39;center&#39;, anchor: &#39;b-more&#39;, height: 122, width: 250, closeClickDetection: true, hideClickDetection: true, relayOpen: -1 }, function(iframe) { anchor.__m = iframe; } ); }); } return false;">æ´å¤
<span class="arrow"></span></a></td>
<td class="navbar-right" align="right" nowrap valign="middle">
<a class="b-link" href="https://www.blogger.com/home#create" id="b-getorpost" tabindex="8">å»ºç«ç¶²èª</a>
<a class="b-link" href="https://www.blogger.com" tabindex="9">ç»å¥</a></td></tr></table></div></div>
