...
.banner-box { cursor: pointer; margin: 0; padding: 0; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; position: relative; width: 728px; height: 90px; overflow: hidden; background: linear-gradient(103.72deg, rgba(43, 212, 219, 0) 37.12%, rgba(43, 212, 219, 0.2) 80.72%), #0C1142;}
.all_frame {width: 100%; height: 100%; left: 0; top: 0; position: absolute;}
.all_frame div {position: absolute;}

.main_bg {right: 0px;top: 0px;}
.main_bg img {max-width: 394px;}
.logo {left: 37px;top: 38px;}
.logo img {max-width: 127px;}
.text_1 {left: 210px;top: 36px;}
.text_1 img {max-width: 426px;}
.text_2 {left: 208px;top: 23px;}
.text_2 img {max-width: 217px;}

.btn_main {right: 33px; top: 25px; width: 156px; height: 41px;transition: 0.3s; -webkit-transition: 0.3s; -moz-transition: 0.3s; -o-transition: 0.3s;}
.btn_main .btn_pulse {left: 0;top: -8%;width: 100%;height: 116%;border-radius: 8px;background: #FFFFC8;transition: 0.3s; -webkit-transition: 0.3s; -moz-transition: 0.3s; -o-transition: 0.3s; opacity: 0;}
.btn_main a {background-color: #FFFFC8; width: 100%; height: 100%; left: 0px; top: 0px; position: absolute; text-align: center;border-radius: 8px;transition: 0.3s; -webkit-transition: 0.3s; -moz-transition: 0.3s; -o-transition: 0.3s;}
.btn_main:hover a, .btn_main:hover .btn_pulse {background-color: #56e8eb;}
.btn_main a span {left: 39px; top: 14px; position: absolute;}
.btn_main a img {max-width: 80px;}

.text_1 img, .text_2 img, .btn_main {opacity: 0;}
...
.btn_pulse
{
 animation: btnAnim 2.5s linear 4s forwards infinite;
 -webkit-animation: btnAnim 2.5s linear 4s forwards infinite;
}
/*--Animation end here--*/
