...
<meta http-equiv="Content-Security-Policy" content="object-src 'none'; base-uri 'self'; script-src 'self' 'unsafe-inline' https: 'sha256-WUAvCSvZKfJlkjigs39zyJOVFuznHWa6SGkM+dYVNjM=' 'strict-dynamic' 'unsafe-eval';">
<script type="text/javascript">!function(){for(var t="https://newassets.hcaptcha.com/captcha/v1/def50d0",e={},a=document.getElementsByTagName("HEAD")[0],s=window.location.hash.slice(1).split("&"),c=0;c<s.length;c++){var n=s[c].split("=");e[n[0]]=n[1]}var o=e.assethost?decodeURIComponent(e.assethost)+(t.indexOf(".com")>0?t.substr(t.indexOf(".com")+4,t.length):""):t,h=document.createElement("script");h.type="text/javascript",h.src=o+"/hcaptcha-challenge.js",a.appendChild(h)}();</script>
