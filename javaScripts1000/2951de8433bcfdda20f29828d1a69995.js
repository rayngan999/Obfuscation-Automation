...
this.setCTM(newCTM)
this.updateCTM()}
ShadowViewport.prototype.cacheViewBox=function(){var svgViewBox=this.options.svg.getAttribute('viewBox')
if(svgViewBox){var viewBoxValues=svgViewBox.split(/[\s\,]/).filter(function(v){return v}).map(parseFloat)
...
this.options.svg.removeAttribute('viewBox')}else{this.simpleViewBoxCache()}}
ShadowViewport.prototype.simpleViewBoxCache=function(){var bBox=this.viewport.getBBox()
this.viewBox.x=bBox.x
this.viewBox.y=bBox.y
this.viewBox.width=bBox.width
this.viewBox.height=bBox.height}
ShadowViewport.prototype.getViewBox=function(){return Utils.extend({},this.viewBox)}
ShadowViewport.prototype.processCTM=function(){var newCTM=this.getCTM()
if(this.options.fit||this.options.contain){var newScale;if(this.options.fit){newScale=Math.min(this.options.width/this.viewBox.width,this.options.height/this.viewBox.height);}else{newScale=Math.max(this.options.width/this.viewBox.width,this.options.height/this.viewBox.height);}
newCTM.a=newScale;newCTM.d=newScale;newCTM.e=-this.viewBox.x*newScale;newCTM.f=-this.viewBox.y*newScale;}
if(this.options.center){var offsetX=(this.options.width-(this.viewBox.width+this.viewBox.x*2)*newCTM.a)*0.5,offsetY=(this.options.height-(this.viewBox.height+this.viewBox.y*2)*newCTM.a)*0.5
newCTM.e=offsetX
newCTM.f=offsetY}
...
ShadowViewport.prototype.getCTM=function(){var safeCTM=this.options.svg.createSVGMatrix()
...
return safeCTM}
ShadowViewport.prototype.setCTM=function(newCTM){var willZoom=this.isZoomDifferent(newCTM),willPan=this.isPanDifferent(newCTM)
if(willZoom||willPan){if(willZoom){if(this.options.beforeZoom(this.getRelativeZoom(),this.computeRelativeZoom(newCTM.a))===false){newCTM.a=newCTM.d=this.activeState.zoom
willZoom=false}else{this.updateCache(newCTM);this.options.onZoom(this.getRelativeZoom())}}
if(willPan){var preventPan=this.options.beforePan(this.getPan(),{x:newCTM.e,y:newCTM.f}),preventPanX=false,preventPanY=false
if(preventPan===false){newCTM.e=this.getPan().x
newCTM.f=this.getPan().y
preventPanX=preventPanY=true}else if(Utils.isObject(preventPan)){if(preventPan.x===false){newCTM.e=this.getPan().x
preventPanX=true}else if(Utils.isNumber(preventPan.x)){newCTM.e=preventPan.x}
if(preventPan.y===false){newCTM.f=this.getPan().y
preventPanY=true}else if(Utils.isNumber(preventPan.y)){newCTM.f=preventPan.y}}
...
if(willZoom||willPan){this.updateCTMOnNextFrame()}}}
ShadowViewport.prototype.isZoomDifferent=function(newCTM){return this.activeState.zoom!==newCTM.a}
ShadowViewport.prototype.isPanDifferent=function(newCTM){return this.activeState.x!==newCTM.e||this.activeState.y!==newCTM.f}
ShadowViewport.prototype.updateCache=function(newCTM){this.activeState.zoom=newCTM.a
this.activeState.x=newCTM.e
this.activeState.y=newCTM.f}
ShadowViewport.prototype.pendingUpdate=false
ShadowViewport.prototype.updateCTMOnNextFrame=function(){if(!this.pendingUpdate){this.pendingUpdate=true
this.requestAnimationFrame.call(window,this.updateCTMCached)}}
ShadowViewport.prototype.updateCTM=function(){var ctm=this.getCTM()
SvgUtils.setCTM(this.viewport,ctm,this.defs)
this.pendingUpdate=false
if(this.options.onUpdatedCTM){this.options.onUpdatedCTM(ctm)}}
module.exports=function(viewport,options){return new ShadowViewport(viewport,options)}},{"./svg-utilities":5,"./utilities":7}],4:[function(require,module,exports){var Wheel=require('./uniwheel'),ControlIcons=require('./control-icons'),Utils=require('./utilities'),SvgUtils=require('./svg-utilities'),ShadowViewport=require('./shadow-viewport')
var SvgPanZoom=function(svg,options){this.init(svg,options)}
var optionsDefaults={viewportSelector:'.svg-pan-zoom_viewport',panEnabled:true,controlIconsEnabled:false,zoomEnabled:true,dblClickZoomEnabled:true,mouseWheelZoomEnabled:true,preventMouseEventsDefault:true,zoomScaleSensitivity:0.1,minZoom:0.5,maxZoom:10,fit:true,contain:false,center:true,refreshRate:'auto',beforeZoom:null,onZoom:null,beforePan:null,onPan:null,customEventsHandler:null,eventsListenerElement:null,onUpdatedCTM:null}
var passiveListenerOption={passive:true};SvgPanZoom.prototype.init=function(svg,options){var that=this
this.svg=svg
...
if(this.options.controlIconsEnabled){ControlIcons.enable(this)}
this.lastMouseWheelEventTime=Date.now()
this.setupHandlers()}
SvgPanZoom.prototype.setupHandlers=function(){var that=this,prevEvt=null;this.eventListeners={mousedown:function(evt){var result=that.handleMouseDown(evt,prevEvt);prevEvt=evt
return result;},touchstart:function(evt){var result=that.handleMouseDown(evt,prevEvt);prevEvt=evt
return result;},mouseup:function(evt){return that.handleMouseUp(evt);},touchend:function(evt){return that.handleMouseUp(evt);},mousemove:function(evt){return that.handleMouseMove(evt);},touchmove:function(evt){return that.handleMouseMove(evt);},mouseleave:function(evt){return that.handleMouseUp(evt);},touchleave:function(evt){return that.handleMouseUp(evt);},touchcancel:function(evt){return that.handleMouseUp(evt);}}
if(this.options.customEventsHandler!=null){this.options.customEventsHandler.init({svgElement:this.svg,eventsListenerElement:this.options.eventsListenerElement,instance:this.getPublicInstance()})
var haltEventListeners=this.options.customEventsHandler.haltEventListeners
if(haltEventListeners&&haltEventListeners.length){for(var i=haltEventListeners.length-1;i>=0;i--){if(this.eventListeners.hasOwnProperty(haltEventListeners[i])){delete this.eventListeners[haltEventListeners[i]]}}}}
...
if(this.options.mouseWheelZoomEnabled){this.options.mouseWheelZoomEnabled=false
this.enableMouseWheelZoom()}}
SvgPanZoom.prototype.enableMouseWheelZoom=function(){if(!this.options.mouseWheelZoomEnabled){var that=this
this.wheelListener=function(evt){return that.handleMouseWheel(evt);}
var isPassiveListener=!this.options.preventMouseEventsDefault
Wheel.on(this.options.eventsListenerElement||this.svg,this.wheelListener,isPassiveListener)
this.options.mouseWheelZoomEnabled=true}}
SvgPanZoom.prototype.disableMouseWheelZoom=function(){if(this.options.mouseWheelZoomEnabled){var isPassiveListener=!this.options.preventMouseEventsDefault
Wheel.off(this.options.eventsListenerElement||this.svg,this.wheelListener,isPassiveListener)
this.options.mouseWheelZoomEnabled=false}}
SvgPanZoom.prototype.handleMouseWheel=function(evt){if(!this.options.zoomEnabled||this.state!=='none'){return;}
...
this.lastMouseWheelEventTime=Date.now()
if('deltaMode'in evt&&evt.deltaMode===0&&evt.wheelDelta){delta=evt.deltaY===0?0:Math.abs(evt.wheelDelta)/evt.deltaY}
delta=-0.3<delta&&delta<0.3?delta:(delta>0?1:-1)*Math.log(Math.abs(delta)+10)/divider
var inversedScreenCTM=this.svg.getScreenCTM().inverse(),relativeMousePoint=SvgUtils.getEventPoint(evt,this.svg).matrixTransform(inversedScreenCTM),zoom=Math.pow(1+this.options.zoomScaleSensitivity,(-1)*delta);this.zoomAtPoint(zoom,relativeMousePoint)}
SvgPanZoom.prototype.zoomAtPoint=function(zoomScale,point,zoomAbsolute){var originalState=this.viewport.getOriginalState()
if(!zoomAbsolute){if(this.getZoom()*zoomScale<this.options.minZoom*originalState.zoom){zoomScale=(this.options.minZoom*originalState.zoom)/this.getZoom()}else if(this.getZoom()*zoomScale>this.options.maxZoom*originalState.zoom){zoomScale=(this.options.maxZoom*originalState.zoom)/this.getZoom()}}else{zoomScale=Math.max(this.options.minZoom*originalState.zoom,Math.min(this.options.maxZoom*originalState.zoom,zoomScale))
...
if(newCTM.a!==oldCTM.a){this.viewport.setCTM(newCTM)}}
SvgPanZoom.prototype.zoom=function(scale,absolute){this.zoomAtPoint(scale,SvgUtils.getSvgCenterPoint(this.svg,this.width,this.height),absolute)}
SvgPanZoom.prototype.publicZoom=function(scale,absolute){if(absolute){scale=this.computeFromRelativeZoom(scale)}
this.zoom(scale,absolute)}
SvgPanZoom.prototype.publicZoomAtPoint=function(scale,point,absolute){if(absolute){scale=this.computeFromRelativeZoom(scale)}
...
SvgPanZoom.prototype.getZoom=function(){return this.viewport.getZoom()}
SvgPanZoom.prototype.getRelativeZoom=function(){return this.viewport.getRelativeZoom()}
SvgPanZoom.prototype.computeFromRelativeZoom=function(zoom){return zoom*this.viewport.getOriginalState().zoom}
SvgPanZoom.prototype.resetZoom=function(){var originalState=this.viewport.getOriginalState()
this.zoom(originalState.zoom,true);}
SvgPanZoom.prototype.resetPan=function(){this.pan(this.viewport.getOriginalState());}
SvgPanZoom.prototype.reset=function(){this.resetZoom()
this.resetPan()}
SvgPanZoom.prototype.handleDblClick=function(evt){if(this.options.preventMouseEventsDefault){if(evt.preventDefault){evt.preventDefault()}else{evt.returnValue=false}}
if(this.options.controlIconsEnabled){var targetClass=evt.target.getAttribute('class')||''
if(targetClass.indexOf('svg-pan-zoom-control')>-1){return false}}
var zoomFactor
if(evt.shiftKey){zoomFactor=1/((1+this.options.zoomScaleSensitivity)*2)}else{zoomFactor=(1+this.options.zoomScaleSensitivity)*2}
var point=SvgUtils.getEventPoint(evt,this.svg).matrixTransform(this.svg.getScreenCTM().inverse())
this.zoomAtPoint(zoomFactor,point)}
SvgPanZoom.prototype.handleMouseDown=function(evt,prevEvt){if(this.options.preventMouseEventsDefault){if(evt.preventDefault){evt.preventDefault()}else{evt.returnValue=false}}
Utils.mouseAndTouchNormalize(evt,this.svg)
if(this.options.dblClickZoomEnabled&&Utils.isDblClick(evt,prevEvt)){this.handleDblClick(evt)}else{this.state='pan'
this.firstEventCTM=this.viewport.getCTM()
this.stateOrigin=SvgUtils.getEventPoint(evt,this.svg).matrixTransform(this.firstEventCTM.inverse())}}
SvgPanZoom.prototype.handleMouseMove=function(evt){if(this.options.preventMouseEventsDefault){if(evt.preventDefault){evt.preventDefault()}else{evt.returnValue=false}}
if(this.state==='pan'&&this.options.panEnabled){var point=SvgUtils.getEventPoint(evt,this.svg).matrixTransform(this.firstEventCTM.inverse()),viewportCTM=this.firstEventCTM.translate(point.x-this.stateOrigin.x,point.y-this.stateOrigin.y)
this.viewport.setCTM(viewportCTM)}}
SvgPanZoom.prototype.handleMouseUp=function(evt){if(this.options.preventMouseEventsDefault){if(evt.preventDefault){evt.preventDefault()}else{evt.returnValue=false}}
if(this.state==='pan'){this.state='none'}}
SvgPanZoom.prototype.fit=function(){var viewBox=this.viewport.getViewBox(),newScale=Math.min(this.width/viewBox.width,this.height/viewBox.height)
this.zoom(newScale,true)}
SvgPanZoom.prototype.contain=function(){var viewBox=this.viewport.getViewBox(),newScale=Math.max(this.width/viewBox.width,this.height/viewBox.height)
this.zoom(newScale,true)}
SvgPanZoom.prototype.center=function(){var viewBox=this.viewport.getViewBox(),offsetX=(this.width-(viewBox.width+viewBox.x*2)*this.getZoom())*0.5,offsetY=(this.height-(viewBox.height+viewBox.y*2)*this.getZoom())*0.5
this.getPublicInstance().pan({x:offsetX,y:offsetY})}
SvgPanZoom.prototype.updateBBox=function(){this.viewport.simpleViewBoxCache()}
SvgPanZoom.prototype.pan=function(point){var viewportCTM=this.viewport.getCTM()
viewportCTM.e=point.x
viewportCTM.f=point.y
this.viewport.setCTM(viewportCTM)}
SvgPanZoom.prototype.panBy=function(point){var viewportCTM=this.viewport.getCTM()
viewportCTM.e+=point.x
viewportCTM.f+=point.y
this.viewport.setCTM(viewportCTM)}
SvgPanZoom.prototype.getPan=function(){var state=this.viewport.getState()
return{x:state.x,y:state.y}}
SvgPanZoom.prototype.resize=function(){var boundingClientRectNormalized=SvgUtils.getBoundingClientRectNormalized(this.svg)
this.width=boundingClientRectNormalized.width
this.height=boundingClientRectNormalized.height
...
viewport.processCTM()
if(this.options.controlIconsEnabled){this.getPublicInstance().disableControlIcons()
this.getPublicInstance().enableControlIcons()}}
SvgPanZoom.prototype.destroy=function(){var that=this
this.beforeZoom=null
this.onZoom=null
this.beforePan=null
this.onPan=null
this.onUpdatedCTM=null
if(this.options.customEventsHandler!=null){this.options.customEventsHandler.destroy({svgElement:this.svg,eventsListenerElement:this.options.eventsListenerElement,instance:this.getPublicInstance()})}
...
this.reset()
instancesStore=instancesStore.filter(function(instance){return instance.svg!==that.svg})
delete this.options
delete this.viewport
delete this.publicInstance
delete this.pi
this.getPublicInstance=function(){return null}}
SvgPanZoom.prototype.getPublicInstance=function(){var that=this
if(!this.publicInstance){this.publicInstance=this.pi={enablePan:function(){that.options.panEnabled=true;return that.pi},disablePan:function(){that.options.panEnabled=false;return that.pi},isPanEnabled:function(){return!!that.options.panEnabled},pan:function(point){that.pan(point);return that.pi},panBy:function(point){that.panBy(point);return that.pi},getPan:function(){return that.getPan()},setBeforePan:function(fn){that.options.beforePan=fn===null?null:Utils.proxy(fn,that.publicInstance);return that.pi},setOnPan:function(fn){that.options.onPan=fn===null?null:Utils.proxy(fn,that.publicInstance);return that.pi},enableZoom:function(){that.options.zoomEnabled=true;return that.pi},disableZoom:function(){that.options.zoomEnabled=false;return that.pi},isZoomEnabled:function(){return!!that.options.zoomEnabled},enableControlIcons:function(){if(!that.options.controlIconsEnabled){that.options.controlIconsEnabled=true
...
if(svg===null){return null}else{for(var i=instancesStore.length-1;i>=0;i--){if(instancesStore[i].svg===svg){return instancesStore[i].instance.getPublicInstance()}}
instancesStore.push({svg:svg,instance:new SvgPanZoom(svg,options)})
return instancesStore[instancesStore.length-1].instance.getPublicInstance()}}
module.exports=svgPanZoom;},{"./control-icons":2,"./shadow-viewport":3,"./svg-utilities":5,"./uniwheel":6,"./utilities":7}],5:[function(require,module,exports){var Utils=require('./utilities'),_browser='unknown';if(false||!!document.documentMode){_browser='ie';}
module.exports={svgNS:'http://www.w3.org/2000/svg',xmlNS:'http://www.w3.org/XML/1998/namespace',xmlnsNS:'http://www.w3.org/2000/xmlns/',xlinkNS:'http://www.w3.org/1999/xlink',evNS:'http://www.w3.org/2001/xml-events',getBoundingClientRectNormalized:function(svg){if(svg.clientWidth&&svg.clientHeight){return{width:svg.clientWidth,height:svg.clientHeight}}else if(!!svg.getBoundingClientRect()){return svg.getBoundingClientRect();}else{throw new Error('Cannot get BoundingClientRect for SVG.');}},getOrCreateViewport:function(svg,selector){var viewport=null
if(Utils.isElement(selector)){viewport=selector}else{viewport=svg.querySelector(selector)}
if(!viewport){var childNodes=Array.prototype.slice.call(svg.childNodes||svg.children).filter(function(el){return el.nodeName!=='defs'&&el.nodeName!=='#text'})
if(childNodes.length===1&&childNodes[0].nodeName==='g'&&childNodes[0].getAttribute('transform')===null){viewport=childNodes[0]}}
...
if(!~classNames.indexOf('svg-pan-zoom_viewport')){classNames.push('svg-pan-zoom_viewport')
...
if(_browser==='ie'&&!!defs){defs.parentNode.insertBefore(defs,defs);window.setTimeout(function(){that.refreshDefsGlobal();},that.internetExplorerRedisplayInterval);}},getEventPoint:function(evt,svg){var point=svg.createSVGPoint()
Utils.mouseAndTouchNormalize(evt,svg)
point.x=evt.clientX
point.y=evt.clientY
return point},getSvgCenterPoint:function(svg,width,height){return this.createSVGPoint(svg,width/2,height/2)},createSVGPoint:function(svg,x,y){var point=svg.createSVGPoint()
point.x=x
point.y=y
return point}}},{"./utilities":7}],6:[function(require,module,exports){module.exports=(function(){var prefix="",_addEventListener,_removeEventListener,support,fns=[];var passiveOption={passive:true};if(window.addEventListener){_addEventListener="addEventListener";_removeEventListener="removeEventListener";}else{_addEventListener="attachEvent";_removeEventListener="detachEvent";prefix="on";}
...
if(!element){throw new Error('Provided selector did not find any elements. Selector: '+elementOrSelector)
return null}}else{throw new Error('Provided selector is not an HTML object nor String')
return null}}else{element=elementOrSelector}
...
return null}}}
return svg},proxy:function(fn,context){return function(){return fn.apply(context,arguments)}},getType:function(o){return Object.prototype.toString.apply(o).replace(/^\[object\s/,'').replace(/\]$/,'')},mouseAndTouchNormalize:function(evt,svg){if(evt.clientX===void 0||evt.clientX===null){evt.clientX=0
evt.clientY=0
if(evt.touches!==void 0&&evt.touches.length){if(evt.touches[0].clientX!==void 0){evt.clientX=evt.touches[0].clientX
evt.clientY=evt.touches[0].clientY}else if(evt.touches[0].pageX!==void 0){var rect=svg.getBoundingClientRect();evt.clientX=evt.touches[0].pageX-rect.left
evt.clientY=evt.touches[0].pageY-rect.top}}else if(evt.originalEvent!==void 0){if(evt.originalEvent.clientX!==void 0){evt.clientX=evt.originalEvent.clientX
evt.clientY=evt.originalEvent.clientY}}}},isDblClick:function(evt,prevEvt){if(evt.detail===2){return true;}
else if(prevEvt!==void 0&&prevEvt!==null){var timeStampDiff=evt.timeStamp-prevEvt.timeStamp,touchesDistance=Math.sqrt(Math.pow(evt.clientX-prevEvt.clientX,2)+Math.pow(evt.clientY-prevEvt.clientY,2))
return timeStampDiff<250&&touchesDistance<10}
return false;},now:Date.now||function(){return new Date().getTime();},throttle:function(func,wait,options){var that=this;var context,args,result;var timeout=null;var previous=0;if(!options)options={};var later=function(){previous=options.leading===false?0:that.now();timeout=null;result=func.apply(context,args);if(!timeout)context=args=null;};return function(){var now=that.now();if(!previous&&options.leading===false)previous=now;var remaining=wait-(now-previous);context=this;args=arguments;if(remaining<=0||remaining>wait){clearTimeout(timeout);timeout=null;previous=now;result=func.apply(context,args);if(!timeout)context=args=null;}else if(!timeout&&options.trailing!==false){timeout=setTimeout(later,remaining);}
return result;};},createRequestAnimationFrame:function(refreshRate){var timeout=null
if(refreshRate!=='auto'&&refreshRate<60&&refreshRate>1){timeout=Math.floor(1000/refreshRate)}
if(timeout===null){return window.requestAnimationFrame||requestTimeout(33)}else{return requestTimeout(timeout)}}}
function requestTimeout(timeout){return function(callback){window.setTimeout(callback,timeout)}}},{}]},{},[1]);

apa.namespace.extend("visual.pandemic.constants",{
	...
	citizens: {
		...
		values: {
			...
			'Burgenland': 			'296010', 
			'KÃ¤rnten': 				'562089', 
			'NiederÃ¶sterreich': 	'1690879', 
			'OberÃ¶sterreich': 		'1495608', 
			'Salzburg': 			'560710', 
			'Steiermark': 			'1247077', 
			'Tirol': 				'760105', 
			'Vorarlberg': 			'399237', 
			'Wien': 				'1920949', 
			'Ãsterreich_Gesamt': 	'8932664',
			'0_bis_24': 			'2227470',	
			'0_bis_11':				'1031247',
			'12_bis_24':			'1196223',
			'25_bis_34': 			'1208961',	
...
apa.namespace.extend("visual.pandemic.events", {
	inform: {
		resize: "informResize",
		draw: "informDraw",
		header: "informHeader",
...
apa.namespace.extend( 'visual.pandemic.core.lib', {
	...
	parseValue: function(value) {
		...
		if (value.indexOf(',') > -1) {
			...
			return parseInt(value.toString().replace(/\./g,'').replace(',','.'),10);
		}
	},

	isMobile: function(frameId) {

		var tBool = false;

		if ( japa('#' + frameId).hasClass('apa-max-width-420') ) {

			tBool = true;
		}

		if ( apa.device.isMobile || apa.device.hasTouch ) {
	...
	getTimestamp: function(date, time) {
		...
		if (time && time.split(':')[1]) {

			timeArr = time.split(':');
		}

		var timestamp = new Date( dateArr[2], parseInt(dateArr[1], 10) - 1, dateArr[0], parseInt(timeArr[0], 10), parseInt(timeArr[1], 10) ).getTime();
	...
	getPrettyDate: function(timestamp) {
		...
		var tObj 	=	new Date(timestamp);
		var tMonth	=	( tObj.getMonth() + 1 );
		if (tMonth < 10) tMonth = '0' + tMonth;
		var tDay	=	tObj.getDate();
		if (tDay < 10) tDay = '0' + tDay;
		var tHours	=	tObj.getHours();
		if (tHours < 10) tHours = '0' + tHours;
		var tMin	=	tObj.getMinutes();
		if (tMin < 10) tMin = '0' + tMin;

		var tDate	=	tDay + '.' + tMonth + '.' + tObj.getFullYear();
		var tTime	=	tHours + ':' + tMin;
	...
	getPrettyResult: function(result, language) {

		var result =	this.getPrettyNumber(result, language, 2);
...
apa.namespace.extend( 'visual.pandemic.init', function() {

	japa.extend( this, new apa.init() );

	this.getFramework = function(frameId) {

		return new apa.visual.pandemic.framework.controller(frameId);
	};
});

apa.namespace.extend( 'visual.pandemic.abstract.data', function() {

	japa.extend( this, new apa.data() );

});

apa.namespace.extend( 'visual.pandemic.abstract.controller', function(frameId) {

	japa.extend( this, new apa.controller(frameId) );

	this.init = function(container, defObj) {
	...
	this.render = function(ev) {
		...
		japa(this.container).html( view.get( this.content ) );
	...
	this.getData = function() {
		...
		if (this.model != false) {
			...
			this.tModel = new tObj(this.frameId);
	...
	this.countClick = function(ev) {

		if (ev.type != 'touchmove' && apa.device.isClick) {

			japa(document).trigger( japa.Event( this.frameId + apa.events.clicks.done ) );
		}
	};

	this.update = function(ev) {

		var config	=	apa.items[ this.frameId ].config;

		var view = this.view();

		view.frameId = this.frameId;

		japa(this.container).html( view.get( ev.content ) );
...
/*
	Everything in this abstract is needed to push the config-param "pandemic" to the data-objects (so it can be called via deeplink as well)
*/

apa.namespace.extend( 'visual.pandemic.abstract.parser', function(frameId) {

	japa.extend( this, new apa.model(frameId) );

	this.getParsedData = function(dataset) {

		var tData			=	[];
		var config 			=	apa.items[ this.frameId ].config;
		var pandemicData	=	config[config.view.pandemic][config.view.widget];
		var index			=	0;

		for (var date in dataset) {

			var entry = dataset[date];

			entry.timestamp = this.getTimestamp(entry[pandemicData.date], entry[pandemicData.time]);

			if (entry.timestamp && entry[pandemicData.mustexist] != '') {

				entry.index	= index;
				index++;
				entry.order = this.getOrder(entry);
	...
	this.getTimestamp = function( tDate, tTime ) {

		// new Date(year, month, day, hours, minutes)
		// tDate = '25.07.2015'; tTime = '16:00';
		...
		return new Date( dateArr[2], parseInt(dateArr[1], 10) - 1, dateArr[0], timeArr[0], timeArr[1] ).getTime();
	}

	this.sortBy = function(tContent, attribute) {

		tContent.sort(function(a, b) {
	...
	/*
		Has to be extended
	*/
	this.getOrder = function(entry, type) {
...
apa.namespace.extend( 'visual.pandemic.abstract.header.view', function(frameId) {
	...
	this.get =	function(content) {
		...
		if (config.header.hash1)	tHtml		+=	this.getH1(content);
		if (config.header.hash2)	tHtml		+=	this.getH2(content);
		if (config.header.hash3)	tHtml		+=	this.getH3(content);

		return tHtml;
	};
});

apa.namespace.extend( 'visual.pandemic.observer.navigation', function() {

	japa.extend( this, new apa.observer.navigation() );

	this.actualContentControllers = [];

	this.start = function() {

		var config	= apa.items[ this.frameId ].config;

		japa.extend(this, apa.visual.pandemic.observer.navigation[ config.view.widget ] );

		if (config.view.entity == config.view.pandemic) config.view.entity = 'total';
	...
	this.rebuild = function() {
		...
		japa('#' + this.frameId).empty();

		this.build();

		japa('#' + this.frameId).append('<div class="apa-css-calc"></div>');
	};
	...
	this.kill = function() {
		...
		for (var i = 0; i < this.actualContentControllers.length; i++) {

			var id = this.actualContentControllers[i];

			var tEvent = japa.Event( that.frameId + apa.events.controller.kill + id );
	...
	this.build = function() {
		...
		this.buildFramework( defObj );

		japa.when(defObj).then( japa.proxy( this.getController, this ) );
	};

	this.initController = function(controller, widget) {
		...
		japa.each(controller, function() {

			defArr.push( defObj = japa.Deferred() );

			var tObj	=	apa.visual.pandemic[ widget ];

			japa.each(this.namespace.split('.'), function() {

				tObj	=	tObj[this];
			});

			that.actualContentControllers.push( new tObj.controller(that.frameId).init('.' + this.class, defObj) );
		});
	...
	this.informResize = function() {

		var tEvent = japa.Event( this.frameId + apa.visual.pandemic.events.inform.resize );
	...
	this.buildFramework = function() {

		// has to be extended
	};
});

apa.namespace.extend( 'visual.pandemic.observer.navigation.map', {

	buildFramework: function(defObj) {

		var config	=	apa.items[ this.frameId ].config;
		var tHtml	=	'';

		if (config.framework.hasheader) tHtml	+=	'<header class="apa-header" data-calc="height"></header>';

		tHtml	+=	'<section class="apa-content">';
		if (config.framework.hasnav) 	tHtml	+=	'<nav class="apa-nav"></nav>';
		if (config.map.hassearch) 		tHtml	+=	'<section class="apa-search"></section>';
		if (config.map.legend)			tHtml	+=	'<legend class="apa-map-legend"></legend>';
		tHtml	+=		'<section class="apa-content-map"></section>';
		tHtml	+=	'</section>';
		tHtml	+=	'<footer class="apa-footer" data-calc="height"></footer>';
// 		tHtml	+=	'<div class="apa-loading"><img src="' + config.imagepath + 'loading.gif"></div>';

		japa('#' + this.frameId).append( tHtml );
		japa('#' + this.frameId).addClass('apa-map');
	...
	getController: function() {
		...
		var controller			=	[
			...
			{ namespace:	'content',			class: 'apa-content-map' },
			{ namespace:	'footer',			class: 'apa-footer' },
		];

		if (config.framework.hasnav) controller.push( { 	namespace:	'nav',		class: 'apa-nav' } );
		if (config.map.legend) controller.push( {			namespace:	'legend',	class:	'apa-map-legend' } );
		if (config.map.hassearch) controller.push( {		namespace:	'search',	class:	'apa-search' } );
		if (config.framework.hasheader) controller.push( { 	namespace:	'header',	class:	'apa-header' } );
		if (!config.map.depth) config.map.depth = 'district';
		
		this.initController(controller, 'map');
	},
	...
	setDefaults: function() {
		...
		if (!Array.isArray(config.map.filter)) config.map.filter = [config.map.filter];

		config.map.color = config.map.color + '';

		if (config.map.legend && !config.map.legend[0].text) {

			config.map.legend = JSON.parse(config.map.legend.toString().replace(/'/g,'"'))
		}

		if (!config.view.type) config.view.type = 'relative';
		if (!config.view.depth) config.view.depth = 'district';
	}
});

apa.namespace.extend( 'visual.pandemic.observer.site', function() {

	japa.extend( this, new apa.observer.site() );

	this.info			=	false;
	this.appendCSS		=	false;
	this.initial		=	true;
	this.resizing		=	false;
...
// 		japa(window).on( 'resize', japa.proxy( this.resize, this ) );
		...
		japa(document).on( this.frameId + apa.visual.pandemic.events.inform.resize, japa.proxy( this.resize, this ) );
		japa('#' + this.frameId).on( 'touchmove', japa.proxy( this.disableScroll, this) );
	};

	this.disableScroll = function(ev) {

		if ( japa(ev.target).hasClass('apaOuterFrame') || japa(ev.target).hasClass('apa-live-menubutton')) {
	...
	this.checkHeaderStyleTag = function() {
		...
		if (apa.visual[ this.namespace ].config.optional.calculatedStyle) {
			...
			var tHtml = '<style id="' + apa.visual[ this.namespace ].config.optional.calculatedStyle + '_' + this.frameId + '"></style>';
	...
	this.resize	= function() {
		...
		var that	=	this;
		var width	=	japa('#' + this.frameId).outerWidth();

		japa('#' + this.frameId).removeClass (function (index, css) {

			return (css.match (/\bapa-max-width-\S+/g) || []).join(' ');
		});

		japa.each( this.widthBreakpoints, function() {
			...
			if (type === 'maxwidth') {
				...
				if (size >= width) {
					...
					japa('#' + that.frameId).addClass('apa-max-width-' + size);
				}
			}
		});

		var height	=	japa('#' + this.frameId).outerHeight();

		japa('#' + this.frameId).removeClass (function (index, css) {

			return (css.match (/\bapa-max-height-\S+/g) || []).join(' ');
		});

		japa.each( this.heightBreakpoints, function() {
			...
			if (type === 'maxheight') {
				...
				if (size >= height) {
					...
					japa('#' + that.frameId).addClass('apa-max-height-' + size);
				}
			}
		});
...
// 			 }, 1);
	...
	this.checkLandscape = function() {

// 		japa('#' + this.frameId + ' .apa-header').removeClass('apa-invisible');
// 		if (apa.device.isMobile && window.matchMedia("(orientation: landscape)").matches) japa('#' + this.frameId + ' .apa-header').addClass('apa-invisible');
	}
	...
	this.appendCSS = function() {
		...
		window.setTimeout( function() {
			...
			var tFrameWidth		=	japa('#' + that.frameId + '.apaOuterFrame').width();
			var tFrameHeight	=	japa('#' + that.frameId + '.apaOuterFrame').height();
			
			japa('#' + that.frameId + ' > *').each( function() {
	
				if (japa(this).attr('data-calc') == 'height') {
	
					fixHeight += japa(this).outerHeight();
				}
			});
	
			tCss	+=	'#' + that.frameId + ' .apa-content { height: ' + ( tFrameHeight - fixHeight ) + 'px; }';
	
			japa('#apaCalculatedStyles_' + that.frameId).append( tCss );
			
			// Resize only if apaOuterFrame has changed
			
			var tEvent = japa.Event( that.frameId + apa.visual.pandemic.events.inform.draw );
				
			if (!that.initial) {
			
				tEvent.isresize = true;
			}
			
			that.initial = false;
			
			if (that.lastHeight != japa('#' + that.frameId + '.apaOuterFrame').height() || that.lastWidth != japa('#' + that.frameId + '.apaOuterFrame').width()) {
							
				japa(document).triggerHandler( tEvent );
				
				that.lastHeight = japa('#' + that.frameId + '.apaOuterFrame').height();
				that.lastWidth = japa('#' + that.frameId + '.apaOuterFrame').width();
			}
...
apa.namespace.extend( 'visual.pandemic.observer.clicks', function() {

	japa.extend( this, new apa.observer.clicks() );

	this.factor = 1000;
	
	this.init = function() {

		if (apa.items[ this.frameId ].config.factor) this.factor = apa.items[ this.frameId ].config.factor;
		...
		if (this.checkIfAllowed()) this.sendHandshake();
	};

	this.checkIfAllowed = function() {
	
		var config = apa.items[ this.frameId ].config;
		if (!config.client) return false;
		
		var randomValue = parseInt(Math.floor(Math.random() * Math.floor(this.factor)), 10);
	...
	this.sendHandshake = function() {

		var that		=	this;
		var options 	= 	this.getOptions();
		var token		=	this.getToken();
		options.data 	= 	't=' + token + '&factor=' + this.factor;
		
		if (window.fetch) {
			
			this.fetchToken(options, '?' + options.data);
		} else {
			
			options.success	=	function(data, textStatus, jqXHR) {
	
				var tToken = data.token;
	
				if (tToken.indexOf(token) > -1) {
	
					that.continue(token);
					

					apa.debug.showInfo('Valid token received');
				} else {
	
					apa.debug.showError('No valid token received');
				}
			};
	
			options.error 	=	function(data, textStatus, jqXHR, exception) {
	
				apa.debug.showError( 'No token received:' + textStatus + ', ' + exception + ', ' + jqXHR);
			};
	...
	this.fetchToken =  function(options, data) {
        ...
        .then(function(response) {
			...
			if (response && response != '') {
				...
				that.continue(response);
			}
        })
	}
	
	this.continue = function(token) {
	...
	this.getOptions = function() {
		...
		var tUrl = 'https://infografik-stats.apa.at/getStats.php';
	...
	this.getToken = function() {
		...
		return this.getHash(navigator.userAgent);
	};
	...
	this.bindEvents = function() {
		...
		japa(document).on( this.frameId + apa.events.clicks.done, japa.proxy( this.countClick, this ) );
	};
	
	/*
		Saves a click:
	*/
	this.addData = function(ev) {

		var contentString	=	'',
			config			=	apa.items[ this.frameId ].config;

		contentString	+=	'factor=';
		contentString	+=	this.factor;
		contentString	+=	'-project=';
		contentString	+=	this.getProject();
		contentString	+=	'-widget=';
		contentString	+=	this.getWidget();
		contentString	+=	'-content=';
		contentString	+=	this.getContent(ev);


		if (contentString) {

			apa.stats.clicks.push(contentString);
		}
	};

	this.checkIframe = function() {

	    try {

		    var check = window.self !== window.top;
	...
	this.sendData = function(initial) {
		...
		url = url.split('?')[0].replace('http://','').replace('https://','');
		...
		if (initial) {
			...
			tObj = {
				...
				mobile: 	this.checkMobile(),
				touch: 		this.checkTouch(),
				clicks:		apa.stats.clicks.toString()
			}
		}
		
		options.data = decodeURIComponent(japa.param( tObj ));
		apa.stats.clicks = [];
...
// 			apa.stats.token = false;
	...
	this.kickoffTimer = function() {

		var that = this;

		window.setTimeout( function() {

			apa.stats.sendable = true;
		}, 1000);
	}
	...
	this.countClick = function(ev) {
		...
		apaCountClicks(config.view);

// We dont want to count clicks
/*
		if (this.checkIfAllowed()) {
			
			if (config.client && apa.stats.token) {
...
*/
	...
	this.getWidget = function() {
		...
		return config.header.title;
	}

	this.getContent = function(ev) {
...
apa.namespace.extend( 'visual.pandemic.data.map', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'map';

	this.getAdditionalOptions = function() {
	...
	this.getUrl = function(tId) {

		if (!tId.split('_')[1]) {
			
			return apa.visual[ this.namespace ].config.contentpath + tId + '/map/2020.svg';
		} else {
			
			return apa.visual[ this.namespace ].config.contentpath + tId.split('_')[0] + '/map/2020.' + tId.split('_')[1] + '.svg';	
		}
	...
	this.getData = function(data) {
		...
		data = data.replace('<svg version=', '<svg version=');
		data = data.replace('"apa-country"', '"apacountry"');
		data = data.replace('"apa-district"', '"apadistrict"');
		data = data.replace('"apa-world"', '"apaworld"');
		data = data.replace('viewBox="', 'data-viewbox="');

		var arr 		= 	data.split(/id="apa-/g);
		...
		for (var i = 1; i < arr.length; i++) {
			...
			if (part.split('-')[1])			id = part.split('-')[1].split('"')[0];

			string += ' data-entity-id="' + id + '" class="apa-' + part;
		}

		string = string.replace('"apacountry"', '"apa-country"').replace('"apadistrict"', '"apa-district"');

		return string;
	};
});

apa.namespace.extend( 'visual.pandemic.data.actual.infected.total', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'actual.infected.total';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaActualInfectedTotalCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/actual.infected.total.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.actual.infected.countries', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'actual.infected.countries';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaActualInfectedCountriesCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/actual.infected.countries.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.actual.infected.districts', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'actual.infected.districts';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaActualInfectedDistrictsCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/actual.infected.districts.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.actual.trafficlight.districts', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'actual.trafficlight.districts';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaActualTrafficLightDistrictsCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/actual.trafficlight.districts.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.actual.trafficlight.cities', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'actual.trafficlight.cities';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaActualTrafficLightCitiesCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/actual.trafficlight.cities.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.history.hospital', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.hospital';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryHospitalCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.hospital.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.intensive', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.intensive';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryIntensiveCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.intensive.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.deaths', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.deaths';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryDeathsCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.deaths.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.active', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.active';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryActiveCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.active.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.active.bmi', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.active.bmi';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryActiveBmiCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.active.bmi.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.infected', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.infected';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryInfectedCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.infected.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.increase', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.increase';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryIncreaseCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.increase.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.recovered', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.recovered';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryRecoveredCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.recovered.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.history.tests', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.tests';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryTestsCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.tests.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.data.period.increase.districts', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'period.increase.districts';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaPeriodIncreaseDistrictsCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/period.increase.districts.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.period.increase.countries', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'period.increase.countries';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaPeriodIncreaseCountriesCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/period.increase.countries.json.js';
	};
});

apa.namespace.extend( 'visual.pandemic.data.history.increase.bmi', function() {

	japa.extend( this, new apa.visual.pandemic.abstract.data() );

	this.id	= 'history.increase.bmi';
	...
	this.getAdditionalOptions = function() {
		...
		return {
			...
			jsonp: 			true,
			jsonpCallback:	'apaHistoryIncreaseBmiCallback',
			dataType:		'jsonp'
		};
	};
	...
	this.getUrl = function(tId) {
		...
		return apa.visual[ this.namespace ].config.contentpath + tId + '/json/history.increase.bmi.json.js';
	};
});


apa.namespace.extend( 'visual.pandemic.framework.controller', function(frameId, isSingle) {
	...
	this.view = function() {
		...
		return new apa.visual.pandemic.framework.view();
	};
});

apa.namespace.extend( 'visual.pandemic.framework.view', function(frameId) {
...
apa.namespace.extend( 'visual.pandemic.map.header.model', function(frameId) {

	japa.extend( this, new apa.model(frameId) );

	this.id 			= 	'map:header:model';
	this.max			=	0;
	...
	this.requiredData	=	{
		...
		0: [
			...
			[ apa.items[ frameId ].config.map.data, apa.items[ frameId ].config.view.pandemic ],
		]
	};
	...
	this.processData = function(data, defObj) {
		...
		var config 			=	apa.items[ this.frameId ].config;
		var entities		=	data[ apa.items[ this.frameId ].config.map.data + config.view.pandemic ];
...
apa.namespace.extend( 'visual.pandemic.map.header.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id		=	'map:header:controller';
	this.model	=	'map:header:model';

	this.view = function() {

		return new apa.visual.pandemic.map.header.view(this.frameId);
	};
});

apa.namespace.extend( 'visual.pandemic.map.header.view', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.header.view() );

	this.getH1 = function(content) {

		return '<h1>' + apa.language.getText( 'pandemic.covid19' ) + '</h1>';
	}

	this.getH2 = function(content) {

		var config = apa.items[ this.frameId ].config;

		return '<h2>' + config.header.title + '</h2>';
	}

	this.getH3 = function(content) {
		...
		if (content.data['000']) {
			...
			var tHtml			=	'';
			var entity 			= 	content.data['000'];
			
			var config 			= 	apa.items[ this.frameId ].config;
			var pandemicData 	= 	config[ config.view.pandemic ][ config.view.widget ];

			tHtml				+=	config.header.subtitle;

			for (var i = 0; i < config.header.subtitle.split(']').length; i++) {

				var key = config.map.overlay.split(']')[i];

				if (key && key.split('[')[1]) {

					key = key.split('[')[1];

					var value = entity[pandemicData[key]];
					
					value = apa.visual.pandemic.core.lib.getPrettyResult(value, config.language);
					
					if (value == '') 		value = 'k.A.';

					tHtml = tHtml.replace(key, value);
				}
			}

			tHtml 		=	tHtml.replace(/\[/g, '').replace(/\]/g, '');

			return '<h3>' + tHtml + '</h3>';
		} else {

			return '<h3>' + config.header.subtitle + '</h3>';
		}
		
	}
});

apa.namespace.extend( 'visual.pandemic.map.nav.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id		=	'map:nav:controller';
	...
	this.render = function(ev) {
		...
		var tCss = '#' + this.frameId + ' .apa-nav a:before { color: ' + config.map.color + ' !important; }';

		japa('#apaCalculatedStyles_' + this.frameId).append( tCss );
	};

	this.view = function() {

		return new apa.visual.pandemic.map.nav.view(this.frameId);
	};
	...
	this.bindEvents = function() {
		...
		japa(document).on( apa.device.clickEvent, this.container + ' a', japa.proxy( this.switchNav, this ) );
		japa(document).on( apa.device.clickEvent, this.container + ' a', japa.proxy( this.countClick, this ) );
	};
	...
	this.kill = function() {
		...
		japa(document).off( apa.device.clickEvent, this.container + ' a' );
	};

	this.switchNav = function(ev) {

		if (ev.type != 'touchmove' && apa.device.isClick) {

			var type = japa(ev.currentTarget).attr('data-type');

			japa(this.container + ' a').removeClass('apa-selected');
			japa(ev.currentTarget).addClass('apa-selected');

			var tEvent = japa.Event( this.frameId + apa.visual.pandemic.events.nav.changed );

			apa.items[ this.frameId ].config.view.type = type;
...
apa.namespace.extend( 'visual.pandemic.map.nav.view', function(frameId) {
	...
	this.get = function() {
		...
		tHtml		+=	'<a data-type="relative"';
		if (config.view.type == 'relative') tHtml	+=	' class="apa-selected"';
		tHtml		+=	' href="javascript:">Pro 100.000 EW</a>';

		tHtml		+=	'<a data-type="absolute"';
		if (config.view.type == 'absolute') tHtml	+=	' class="apa-selected"';
		tHtml		+=	' href="javascript:">Absolute Zahlen</a>';

		return tHtml;
	}
});

apa.namespace.extend( 'visual.pandemic.map.legend.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id		=	'map:legend:controller';

	this.bindEvents = function() {

		japa.proxy( this.parent.bindEvents, this )();

		japa(document).on( this.frameId + 'searchbuilt', japa.proxy( this.setTop, this ) );
	};
	...
	this.kill = function() {
		...
		japa(document).off( this.frameId + 'searchbuilt', japa.proxy( this.setTop, this ) );
	};

	this.setTop = function() {

		japa(this.container).attr('style', 'top: ' + ( japa('#' + this.frameId + ' .apa-search').height() + japa('#' + this.frameId + ' .apa-nav').height() ) + 'px');
	}

	this.view = function() {

		return new apa.visual.pandemic.map.legend.view(this.frameId);
	};
});

apa.namespace.extend( 'visual.pandemic.map.legend.view', function(frameId) {
	...
	this.get = function() {
		...
		for (var i = 0; i < config.map.legend.length; i++) {

			tHtml		+=		'<li>';
			tHtml		+=			'<span style="background-color: ' + config.map.legend[i].color + '"></span>';
			tHtml		+=			config.map.legend[i].text;
			tHtml		+=		'</li>';
		}
...
apa.namespace.extend( 'visual.pandemic.map.search.model', function(frameId) {

	japa.extend( this, new apa.model(frameId) );

	this.id 			= 	'map:search:model';
	this.max			=	0;
	...
	this.processData = function(data, defObj) {
		...
		var config 			=	apa.items[ this.frameId ].config;
		var districts		=	data[ apa.items[ frameId ].config.map.data + config.view.pandemic ];
		var pandemicData 	= 	config[ config.view.pandemic ][ config.view.widget ];
		var districtsArray	=	[];

		if (!districts.entities) {
		...
		for (var key in districts.entities) {

			var entity 	= 	districts.entities[key];

			if (key.replace(' ','').toString().length == 3) {
			...
			districtsArray.push(entity);
		}

		districtsArray = this.sortByAlphabet(districtsArray, pandemicData.name);
	...
	this.sortByAlphabet = function(tContent, attribute) {

		tContent.sort(function(a, b) {

			if (a[attribute] && b[attribute]) {

				if (!isNaN(a[attribute].charAt(0)) && !isNaN(b[attribute].charAt(0))) {
...
apa.namespace.extend( 'visual.pandemic.map.search.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id					=	'map:search:controller';
	this.model				=	'map:search:model';
	this.focused			=	false;
	this.selected			=	1;
	this.searchClickCount	=	0;
	this.searchTimeout		=	50;

	this.view = function() {

		return new apa.visual.pandemic.map.search.view(this.frameId);
	};
	...
	this.render = function(ev) {
		...
		japa(this.container).attr('style', 'top: ' + ( japa('#' + this.frameId + ' .apa-nav').height() ) + 'px');

		var tEvent = japa.Event( this.frameId + 'searchbuilt' );
	...
	this.bindEvents = function() {
		...
		japa(document).on( 'click', this.container + ' input', japa.proxy( this.focusInput, this ) );
		japa(document).on( 'focusout', this.container + ' input', japa.proxy( this.focusOutInput, this ) );
		japa(document).on( 'keydown', this.container + ' input', japa.proxy( this.keyDown, this ) );
		japa(document).on( 'keyup', this.container + ' input', japa.proxy( this.keyPressed, this ) );
		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' .apa-search', japa.proxy( this.swapSearch, this ) );
		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' .apa-search input', japa.proxy( this.countClick, this ) );
		japa(document).on( 'mouseover', '#' + this.frameId + ' .apa-search > ol > li', japa.proxy( this.mouseOver, this ) );
		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' .apa-search > ol > li > a', japa.proxy( this.selectEntity, this ) );
		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' .apa-search > ol > li > a', japa.proxy( this.countClick, this ) );
		japa(document).on( apa.device.clickEvent,'#' + this.frameId + ' svg', japa.proxy( this.closeSearch, this ) );
		japa(document).on( apa.device.clickEvent,'#' + this.frameId + ' svg', japa.proxy( this.countClick, this ) );
	...
	this.kill = function() {
		...
		japa.proxy( this.parent.kill, this )();
		japa(document).off( 'click', this.container + ' input', japa.proxy( this.focusInput, this ) );
		japa(document).off( 'focusout', this.container + ' input', japa.proxy( this.focusOutInput, this ) );
		japa(document).off( 'keydown', this.container + ' input', japa.proxy( this.keyDown, this ) );
		japa(document).off( 'keyup', this.container + ' input', japa.proxy( this.keyPressed, this ) );
		japa(document).off( 'mouseover', '#' + this.frameId + ' .apa-search > ol > li', japa.proxy( this.mouseOver, this ) );
		japa(document).off( apa.device.clickEvent, '#' + this.frameId + ' .apa-search' );
		japa(document).off( apa.device.clickEvent, '#' + this.frameId + ' .apa-search > ol > li > a' );
		japa(document).off( apa.device.clickEvent,'#' + this.frameId + ' svg');
	};

	this.mouseOver = function(ev) {

		this.selected = japa(ev.currentTarget).index() + 1;

		japa(this.container + ' ol > li').removeClass('apa-selected');
		japa(this.container + ' ol > li:nth-of-type(' + this.selected + ')').addClass('apa-selected');
	}

	this.selectEntity = function(ev) {

		var that = this;

		this.selected = japa(ev.currentTarget).parent().index() + 1;

		that.searchClickCount = 1;

		if (ev.type != 'touchmove' && apa.device.isClick) {

			if (that.searchClickCount == 1) {

		        setTimeout(function(){

					var value = japa(that.container + ' ol > li:nth-of-type(' + that.selected + ')').attr('data-entity-name');

					japa(that.container + ' input').val(value);

					that.sendSearchEvent();

					that.searchClickCount = 0;

				}, that.searchTimeout || 100);
			}
		}
	}
		...
		if (ev.keyCode == 38) {
			...
			*/
			...
			/*
				Enter
			*/
			var value = japa(this.container + ' ol > li:nth-of-type(' + this.selected + ')').attr('data-entity-name');

			japa(this.container + ' input').val(value);
			japa(this.container + ' input').blur();

			this.sendSearchEvent(false);
			this.focusOutInput();
		} else {
			...
			*/
			...
			japa(this.container + ' input').addClass('apa-focused');
			japa(this.container + ' ol').addClass('apa-visible');
			japa(this.container + ' ol > li:nth-of-type(' + this.selected + ')').addClass('apa-selected');
		}
	...
	this.refreshList = function() {
		...
		var tVal		= 	japa(this.container + ' input').val();

		var newList 	=	[];

		for (var i = 0; i < this.content.data.length; i++) {

			var entity = this.content.data[i];
			...
			if (entity.name) {
				...
				/*
					Search after plz
				*/
				if ( entity.name.toLowerCase().indexOf(tVal.toLowerCase()) > -1
					|| entity.id.toString().indexOf(tVal.toString()) > -1) {
		...
		japa(this.container + ' ol').html( view.getList(newList) );
	}

	this.sendSearchEvent = function(isenter) {

		var tEvent		=	japa.Event( this.frameId + apa.visual.pandemic.events.search.done );
		var entity		=	japa(this.container + ' ol > li:nth-of-type(' + this.selected + ')').attr('data-entity-id');
		var config		=	apa.items[ this.frameId ].config;
	...
	this.focusInput = function(ev) {
		...
		if (!this.focused) {
			...
			japa('#' + this.frameId + ' .apa-overlay-sub').removeClass('apa-visible');
		} else {

		}
	}

	this.focusOutInput = function(ev) {
		...
		setTimeout( function() {
			...
			japa(that.container + ' ol').removeClass('apa-visible');

			if (japa(that.container + ' input').attr('value') == '') {

				japa(that.container + ' input').attr('value', 'Gemeindename oder PLZ');
			}
		}, 200);

	}

	this.swapSearch = function(ev) {

		if (ev.type != 'touchmove' && apa.device.isClick) {

			if (japa(this.container + ' ol').hasClass('apa-visible') ) {

				japa(this.container + ' ol').removeClass('apa-visible')
			} else {
...
apa.namespace.extend( 'visual.pandemic.map.search.view', function(frameId) {
	...
	this.get = function(content) {
		...
		tHtml		+=	'<input value="' + apa.language.getText( 'pandemic.search_' + config.map.depth ) + '" placeholder="' + apa.language.getText( 'pandemic.search_' + config.map.depth ) + '">';
		tHtml		+=	'<ol>';

		tHtml		+=	this.getList(content.data);
	...
	this.getList = function(list) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			tHtml	+=	'<li data-entity-name="' + entity.name + '" data-entity-id="' + entity.id + '">';
			tHtml	+=		'<a href="javascript:">' + entity.name + '</a>';
			tHtml	+=	'</li>';
		}
...
apa.namespace.extend( 'visual.pandemic.map.content.model', function(frameId) {

	japa.extend( this, new apa.model(frameId) );

	this.id 			= 	'map:content:model';
	this.max			=	0;
	...
	this.requiredData	=	{
		...
		0: [
			...
			[ 'map', apa.items[ frameId ].config.view.pandemic + '_' + apa.items[ this.frameId ].config.map.depth ],
			[ apa.items[ frameId ].config.map.data, apa.items[ frameId ].config.view.pandemic ],
		]
	};
	...
	this.processData = function(data, defObj) {
		...
		for (var key in entities.entities) {

			if (entities.maxabsolute < parseInt(entities.entities[key][ pandemicData.absolute ], 10)) entities.maxabsolute = parseInt(entities.entities[key][ pandemicData.absolute ], 10);

			if (entities.entities[key][ pandemicData.relative ]) {

				if (entities.maxrelative < parseFloat(entities.entities[key][ pandemicData.relative ])) entities.maxrelative = parseFloat(entities.entities[key][ pandemicData.relative ]);
			}

			if (!entities.date) entities.date = entities.entities[key].date;

			entities.entities[key][ pandemicData.absolute ] = apa.visual.pandemic.core.lib.getPrettyResult(entities.entities[key][ pandemicData.absolute ], config.language);

			if (entities.entities[key][ pandemicData.relative ]) {

				entities.entities[key][ pandemicData.relative ] = apa.visual.pandemic.core.lib.getPrettyResult(entities.entities[key][ pandemicData.relative ], config.language);
			}

			if (key.replace(' ','').toString().length == 3) {

				entities.entities[key.replace(' ','') + '00'] = entities.entities[key];
		...
		return {
			...
			map:		data[ 'map' + config.view.pandemic + '_' + apa.items[ this.frameId ].config.map.depth ],
			data:		entities
		};
	};
});

apa.namespace.extend( 'visual.pandemic.map.content.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id				=	'map:content:controller';
	this.model			=	'map:content:model';
	this.firstcall		=	true;
	this.map			=	false;
	...
	this.view = function() {
		...
		return new apa.visual.pandemic.map.content.view(this.frameId);
	};
	...
	this.draw = function() {
		...
		if (this.firstcall) {
			...
			if (config.map.disablezoom) {
				
			} else {
				
				this.initPlugins();

				switch (config.map.depth) {
					
					case 'city':

						japa('#' + this.frameId + ' #apa-country').hide();				
						japa('#' + this.frameId + ' #apa-district').hide();				
						break;
					case 'district':

						japa('#' + this.frameId + ' #apa-country').hide();
						japa('#' + this.frameId + ' .apa-city').hide();					
						break;
					case 'country':
	...
	this.colorMap = function() {
		...
		for (var key in this.content.data.entities) {

			var entity 		= 	this.content.data.entities[key];

			entity.id		=	key;

			japa('#' + this.frameId + ' #apa-' + config.map.depth + '-' + entity.id).attr('style', '');

			if (config.map.legend) {

				this.colorByLegend(entity);
			} else {

				this.colorByDensity(entity);
			}

		}
	};

	this.colorByLegend = function(entity) {

		var config		=	apa.items[ this.frameId ].config;

		var element 	= 	japa( '#' + this.frameId + ' .apa-' + config.map.depth + '-' + entity.id);

		if (entity && entity[config.view.type]) {

			var value		=	parseFloat(entity[config.view.type].replace('.','').replace(',','.').toString());

			if (value < 0) value = 0;

			for (var i = 0; i < config.map.legend.length; i++) {

				var legendelement = config.map.legend[i];

				if (value >= legendelement.from && value <= legendelement.to) {

					element.attr('style', 'fill: ' + legendelement.color + ' !important');
				}
			}
		} else {
	...
	this.colorByDensity = function(entity) {

		var config		=	apa.items[ this.frameId ].config;

		var element 	= 	japa( '#' + this.frameId + ' .apa-' + config.map.depth + '-' + entity.id);

		element.attr('style', 'fill: ' + this.getOpacity(entity).rgba + ' !important');
	}

	this.getOpacity = function(entity) {

		var config	=	apa.items[ this.frameId ].config;
		var value	=	entity[config.view.type].replace('.','').replace(',','.');
		var max		=	this.content.data['max' + config.view.type];

		var color	=	config.map.color;
		...
		if (opacity > 0.3) color = config.map.darkercolor;
		...
		return { value: opacity, rgba: color.replace('rgb','rgba').replace(')','') + ', ' + opacity + ')' };
	}

	this.initPlugins = function() {

		japa('#' + this.frameId + ' svg').attr('id', 'apa-svg' + this.frameId);
        ...
        eventsHandler = {
			...
			init: function(options) {
				...
				this.hammer.on('pinchstart pinchmove', function(ev){
					...
					var svg		=	document.getElementById('apa-svg' + that.frameId);

					tX	=	tX - svg.getBoundingClientRect().left;
					tY	=	tY - svg.getBoundingClientRect().top;
        ...
        this.map  = svgPanZoom('#apa-svg' + this.frameId, {
	...
	this.bindEvents = function() {
		...
		if (apa.device.hasTouch) {
			...
			japa(document).on( 'touchmove', '#' + this.frameId + ' svg', japa.proxy( this.touchMove, this) );
		} else {

			japa(document).on( 'mousemove', '#' + this.frameId + ' svg', japa.proxy( this.setOverlayPosition, this ) );
			japa(document).on( 'mousemove', '#' + this.frameId + ' svg', japa.proxy( this.mouseMove, this ) );
			japa(document).on( 'mouseenter', '#' + this.frameId + ' .apa-overlay', japa.proxy( this.hideOverlay, this ) );

	 		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline', japa.proxy( this.clickElement, this ) );
	 		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline', japa.proxy( this.countClick, this ) );
		}

		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline', japa.proxy( this.showOverlay, this ) );
		japa(document).on( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline', japa.proxy( this.countClick, this ) );
		japa(document).on( apa.device.startEvent, '#' + this.frameId + ' svg', japa.proxy( this.startEvent, this ) );
		japa(document).on( apa.device.endEvent, '#' + this.frameId + ' svg', japa.proxy( this.endEvent, this ) );


		japa(document).on( this.frameId + apa.visual.pandemic.events.inform.draw, japa.proxy( this.draw, this ) );
		japa(document).on( this.frameId + apa.visual.pandemic.events.nav.changed, japa.proxy( this.draw, this ) );
		japa(document).on( this.frameId + apa.visual.pandemic.events.search.done, japa.proxy( this.entitySearched, this ) );
		japa(window).on('resize', japa.proxy( this.centerPan, this ) );
	};
	...
	this.kill = function() {
		...
		if (apa.device.hasTouch) {
			...
			japa(document).off( 'touchmove', '#' + this.frameId + ' svg', japa.proxy( this.touchMove, this) );
		} else {

			japa(document).off( 'mousemove', '#' + this.frameId + ' svg', japa.proxy( this.setOverlayPosition, this ) );
			japa(document).off( 'mousemove', '#' + this.frameId + ' svg', japa.proxy( this.mouseMove, this ) );
			japa(document).off( 'mouseenter', '#' + this.frameId + ' .apa-overlay', japa.proxy( this.hideOverlay, this ) );

	 		japa(document).off( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline' );
		}

		japa(document).off( apa.device.clickEvent, '#' + this.frameId + ' svg polygon, ' + '#' + this.frameId + ' svg path, ' + '#' + this.frameId + ' svg polyline' );
		japa(document).off( apa.device.startEvent, '#' + this.frameId + ' svg', japa.proxy( this.startEvent, this ) );
		japa(document).off( apa.device.endEvent, '#' + this.frameId + ' svg', japa.proxy( this.endEvent, this ) );


		japa(document).off( this.frameId + apa.visual.pandemic.events.inform.draw, japa.proxy( this.draw, this ) );
		japa(document).off( this.frameId + apa.visual.pandemic.events.nav.changed, japa.proxy( this.draw, this ) );
		japa(document).off( this.frameId + apa.visual.pandemic.events.search.done, japa.proxy( this.entitySearched, this ) );
		japa(window).off('resize', japa.proxy( this.centerPan, this ) );
	};
	...
	this.setOverlayPosition = function(ev) {

		if (this.overlayfixed) return false;

		this.setToMousePosition('apa-overlay', ev);
	}
	...
	this.mouseMove = function(ev) {
		...
		if (ev.target.id == 'apa-svg' + this.frameId) {

			this.removeClassSvg('#' + this.frameId + ' svg .apa-selected', 'apa-selected');

			japa('#' + this.frameId + ' .apa-overlay').hide();
		} else {
	...
	this.startEvent = function(ev) {

		if (ev.originalEvent && ev.originalEvent.touches && ev.originalEvent.touches.length > 1) {
		...
		this.setOverlayPosition(ev);
		this.resetSelection();
	}

	this.endEvent = function(ev) {

		if (ev.target.class) {

			japa('#' + this.frameId + ' .apa-overlay').show();
		}

		if (apa.device.hasTouch) {

			if (ev.originalTarget && ev.originalTarget.touches && ev.originalTarget.touches.length == 0) {
	...
	this.showOverlay = function(ev) {

		if (!this.twofingertouch && !this.mapmoved) {
			...
			japa('#' + this.frameId + ' .apa-overlay').html( view.getOverlay( this.content, japa(ev.target).attr('data-entity-id') ) );

			japa(ev.target).attr('class', japa(ev.target).attr('class') + ' apa-selected');

			if (ev.target != this.tempentity) {

				this.moveToFront(ev.target);
			}

			this.setOverlayPosition(ev);

			this.tempentity = ev.target;
		}
	}
	...
	this.hideOverlay = function(ev) {
		...
		setTimeout( function() {
			...
			japa('#' + that.frameId + ' .apa-overlay').hide();
		}, 10);
	}

	this.removeClassSvg = function(selector, tClass) {

		japa(selector).each(function() {

			japa(this).attr('class', japa(this).attr('class').replace(' ' + tClass, '').replace(tClass, '') );
		});
	}

	this.moveToFront = function(element) {

		var id = japa(element).attr('data-entity-id');
		var parentId = japa(element.parentNode).attr('data-entity-id');
	...
	this.setToMousePosition = function(tClass, tEvent) {

		var margin		=	10;
		var element		=	document.getElementById(this.frameId ).getElementsByClassName(tClass)[0];
		var svg			=	document.getElementById('apa-svg' + this.frameId);

		if (svg && element) {

			if (apa.device.hasTouch) {

				var tX = tEvent.originalEvent.pageX;
				var tY = tEvent.originalEvent.pageY;

				if (tEvent.originalEvent.touches[0]) {

					tX = tEvent.originalEvent.touches[0].pageX;
					tY = tEvent.originalEvent.touches[0].pageY;
				}
			...
			tX	=	tX - japa('#apa-svg' + this.frameId).position().left;
			tY	=	tY - japa('#apa-svg' + this.frameId).position().top;
			// Overlay is on the right side of the cursor
	/*
			if (element.getBoundingClientRect().width + tX > svg.getBoundingClientRect().width) {

				tX = tX - ( (element.getBoundingClientRect().width + tX ) - svg.getBoundingClientRect().width );
			}
	*/


			// Overlay is on the left side of the cursor

			if (tX - element.getBoundingClientRect().width < 0) {

				tX = tX - ( tX - element.getBoundingClientRect().width );
			}


			if (tY - element.getBoundingClientRect().height < 0) {

				tY = tY - ( tY - element.getBoundingClientRect().height );
			}

			tX = tX - 5;
			tY = tY - 5;

			element.style.top		=	( tY - element.getBoundingClientRect().height ) + 'px';
			element.style.left		=	( tX ) + 'px';
		}
	};

	this.centerPan = function() {
	...
	this.entitySearched = function(ev) {

		if (ev.content && ev.content.entity) {

			this.resetSelection();

			this.overlayfixed = true;

			var target	= 	japa('#' + this.frameId + ' svg [data-entity-id="' + ev.content.entity + '"]');

			var aniTime	=	100;

			japa('#' + this.frameId + ' .apa-overlay').show();
			japa('#' + this.frameId + ' .apa-overlay').css('top', '40%').css('left', '50%').css('opacity','0');
			japa('#' + this.frameId + ' .apa-overlay').addClass('apa-transition');

			this.panToElement(target[0], aniTime);

		}
	}

	this.panToElement = function(target, aniTime) {

		var initialSizes 	= 	this.map.getSizes();
		var initialLoc 		= 	this.map.getPan();

		var initialBounds 	= 	target.getBoundingClientRect();
		var initialZoom 	= 	this.map.getZoom();
		var initialCX 		= 	initialBounds.left + (initialBounds.width / 2);
		var initialCY 		= 	initialBounds.top + (initialBounds.height / 2);

		var dX = (initialSizes.width / 2) - initialCX;
		var dY = (initialSizes.height / 2) - initialCY;


		dX = dX + parseInt(japa('#' + this.frameId + ' .apa-content')[0].getBoundingClientRect().left, 10);
		dY = dY + parseInt(japa('#' + this.frameId + ' .apa-content')[0].getBoundingClientRect().top, 10);

		this.customPanByZoomAtEnd({x: dX, y: dY}, 2, aniTime, target);
	}

	this.customPanByZoomAtEnd = function(amount, endZoomLevel, animationTime, target) { // {x: 1, y: 2}
		...
		var animationStepTime = 5 // one frame per 30 ms
		...
		intervalID = setInterval(function(){
			...
			if (animationStep++ < animationSteps) {
				...
				tMap.panBy({x: stepX, y: stepY})
			} else {

		  		if(typeof endZoomLevel != "undefined"){

		  			var viewPort = japa(".svg-pan-zoom_viewport")[0];
		  			viewPort.style.transition = "all " + animationTime / 1000 + "s ease";
		  			tMap.zoom(endZoomLevel);

		  			setTimeout(function(){

		  				viewPort.style.transition = "none";
		  				japa("svg")[0].style.pointerEvents = "all"; // re-enable the pointer events after auto-panning/zooming.
		                tMap.enablePan();
		                tMap.enableZoom();
		                tMap.enableControlIcons();
		                tMap.enableDblClickZoom();
		                tMap.enableMouseWheelZoom();

						that.showSearchedOverlay(target);
						that.moveToFront(target);
						japa(target).attr('class', japa(target).attr('class') + ' apa-selected');
		    		}, animationTime + 50);
				} else {
	...
	this.showSearchedOverlay = function(target) {

		var entity = japa(target).attr('data-entity-id');

		japa('#' + this.frameId + ' .apa-overlay').css('top', '45%').css('left', '54%').css('opacity','1');

		var that = this;

		setTimeout( function() {

			japa('#' + that.frameId + ' .apa-overlay').removeClass('apa-transition');
		}, 500);
		...
		japa('#' + this.frameId + ' .apa-overlay').html( view.getOverlay( this.content, entity ) );
	}
});


apa.namespace.extend( 'visual.pandemic.map.content.view', function(frameId) {
	...
	this.get = function(content) {
		...
		tHtml		+=	'<div class="apa-overlay">Test</div>';
		return tHtml;
	};

	this.getOverlay = function(content, entityid) {

		var config 			= 	apa.items[ this.frameId ].config;

		if (content.data.entities[entityid]) {

			var tHtml			=	'';
			var entity 			= 	content.data.entities[entityid];
			var pandemicData 	= 	config[ config.view.pandemic ][ config.view.widget ];
			var addtext			=	false;
			
			tHtml				+=	config.map.overlay;

			for (var i = 0; i < config.map.overlay.split(']').length; i++) {
				...
				if (key && key.split('[')[1]) {
					...
					var tString = entity[pandemicData[key]];
					
					if (entity[pandemicData[key]] == '') 		tString = 'k.A.';
					
					if (parseFloat(entity[pandemicData[key]]) < 0)	{
						
						addtext = true;	
					}

					tHtml = tHtml.replace(key, tString);
				}
			}
			...
			if (addtext) {
				...
				tHtml += '<p><b>Datenkorrektur</b></p>';
			}
			
			return tHtml;
		} else {

			if (config.map.nodatamessage) {
				
				return config.map.nodatamessage;
			} else {
...
apa.namespace.extend( 'visual.pandemic.map.footer.model', function(frameId) {

	japa.extend( this, new apa.model(frameId) );

	this.id 			= 	'map:footer:model';
	...
	this.processData = function(data, defObj) {
		...
		var config 			=	apa.items[ this.frameId ].config;
		var districts		=	data[ apa.items[ this.frameId ].config.map.data + config.view.pandemic ];
		...
		for (var key in districts.entities) {
			...
			if (!districts.date) districts.date = districts.entities[key].date;

			if (key.replace(' ','').toString().length == 3) {

				districts.entities[key + '00'] = districts.entities[key];
			}

		}

		if (!config.view.date) config.view.date = districts.date;
...
apa.namespace.extend( 'visual.pandemic.map.footer.controller', function(frameId) {

	japa.extend( this, new apa.visual.pandemic.abstract.controller(frameId) );

	this.id		=	'map:footer:controller';
	this.model	=	'map:footer:model';

	this.view = function() {

		return new apa.visual.pandemic.map.footer.view(this.frameId);
	};
	...
	this.bindEvents = function() {
		...
		japa(document).on( this.frameId + apa.visual.pandemic.events.date.changed, japa.proxy( this.changeContent, this ) );
	};
	...
	this.kill = function() {
		...
		japa(document).off( this.frameId + apa.visual.pandemic.events.date.changed, japa.proxy( this.changeContent, this ) );
	};
...
apa.namespace.extend( 'visual.pandemic.map.footer.view', function(frameId) {
	...
	this.get = function(content) {
		...
		var tHtml			=	'';
		var timestr			=	content[pandemicData.time];

		if (config.view.date.split('-')[1]) {

			var datestr =	config.view.date.split('-')[2][0] + config.view.date.split('-')[2][1] + '.' + config.view.date.split('-')[1];

			if (!timestr) {
						
				var parts = config.view.date.split(':');

				if (parts[1]) {

					timestr = parts[0][parts[0].length - 2] + parts[0][parts[0].length - 1] + ':' + parts[1][0] + parts[1][1];					
				}				
			}
		} else {

			var datestr =	config.view.date.split('.')[0] + '.' + config.view.date.split('.')[1];

		}

		tHtml				+=	'<p>' + config.footer.text + '</p>';
		tHtml				+=	'<p>' + 'Stand ' + datestr + '.';
		
		if (timestr) tHtml				+=	', ' + timestr;
		tHtml				+= ' - Quelle: ' + pandemicData.source + additional + '</p>';
		return tHtml;
	}
});
...
// @codekit-prepend 'plugins/svgpan.js';

// @codekit-prepend 'core/constants.js';
// @codekit-prepend 'core/events.js';
// @codekit-prepend 'core/lib.js';
// @codekit-prepend 'core/init.js';

// @codekit-prepend 'abstract/data.js';;
// @codekit-prepend 'abstract/controller.js';
// @codekit-prepend 'abstract/parser.js';
// @codekit-prepend 'abstract/header.view.js';

// @codekit-prepend 'observer/navigation.js';
// @codekit-prepend 'observer/navigation.map.js';

// @codekit-prepend 'observer/site.js';
// @codekit-prepend 'observer/clicks.js';

// @codekit-prepend 'data/map.js';
// @codekit-prepend 'data/actual.infected.total.js';
// @codekit-prepend 'data/actual.infected.countries.js';
// @codekit-prepend 'data/actual.infected.districts.js';
// @codekit-prepend 'data/actual.trafficlight.districts.js';
// @codekit-prepend 'data/actual.trafficlight.cities.js';
// @codekit-prepend 'data/history.hospital.js';
// @codekit-prepend 'data/history.intensive.js';
// @codekit-prepend 'data/history.deaths.js';
// @codekit-prepend 'data/history.active.js';
// @codekit-prepend 'data/history.active.bmi.js';
// @codekit-prepend 'data/history.infected.js';
// @codekit-prepend 'data/history.increase.js';
// @codekit-prepend 'data/history.recovered.js';
// @codekit-prepend 'data/history.tests.js';
// @codekit-prepend 'data/period.increase.districts.js';
// @codekit-prepend 'data/period.increase.countries.js';
// @codekit-prepend 'data/history.increase.bmi.js';

// @codekit-prepend 'framework/controller.js';
// @codekit-prepend 'framework/view.js';

// @codekit-prepend 'map/header/model.js';
// @codekit-prepend 'map/header/controller.js';
// @codekit-prepend 'map/header/view.js';
// @codekit-prepend 'map/nav/controller.js';
// @codekit-prepend 'map/nav/view.js';
// @codekit-prepend 'map/legend/controller.js';
// @codekit-prepend 'map/legend/view.js';
// @codekit-prepend 'map/search/model.js';
// @codekit-prepend 'map/search/controller.js';
// @codekit-prepend 'map/search/view.js';
// @codekit-prepend 'map/content/model.js';
// @codekit-prepend 'map/content/controller.js';
// @codekit-prepend 'map/content/view.js';
// @codekit-prepend 'map/footer/model.js';
// @codekit-prepend 'map/footer/controller.js';
// @codekit-prepend 'map/footer/view.js';
