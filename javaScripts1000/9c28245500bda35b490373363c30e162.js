(function($){
 $.fn.horizontalScroll = function(options) {
  ...
  return this.each(function() {
			    ...
			    horiz_scroll.setUpScrollbar("dragBar", "track", "h", 0, -4);
			    horiz_scroll.setUpScrollControls('scrollbar');
                            var ended = jQuery('#calendarSlider .ended').length;
                            horiz_scroll.initScrollToVals(ended*150,0,1);
 ...
 $.fn.horizontalScroll1 = function(options) {
  ...
  return this.each(function() {
				...
				horiz_scroll.setUpScrollbar("dragBar1", "track1", "h", 0, -4);
			    horiz_scroll.setUpScrollControls('scrollbar1');
                            var ended = jQuery('#calendarSlider1 .ended').length;
                            horiz_scroll.initScrollToVals(ended*150,0,1);
