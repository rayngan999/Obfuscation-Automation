...
//                        console.info(secondCon_viX);
                    ...
                    if (scrollbarx) {
                        ...
                        if(o.type=='normal'){
                            ...
                            if(margs.called_from=='touch_scroll_on_sc'){
                        ...
                        if(o.secondCon && typeof secondCon_viX!='undefined'){
                            ...
                            if(margs.called_from=='touch_scroll_on_inner'){
...
//                    console.info(cthis_touch_left, cthis_touch_comwidth, totalWidth, scrollbarx_psize);
                    ...
                    if(is_touch_device()){
                        args.called_from = 'touch_scroll_on_inner'
                    }
                    // scrollIndexX = 0;
                ...
                if(sc_dragging){
                    ...
                    if(is_touch_device()){
                        args.called_from = 'touch_scroll_on_sc'
                    }
