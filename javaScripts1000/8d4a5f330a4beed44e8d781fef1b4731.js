...
<div id="form_10955_" class="bs-shortcode bs-login-shortcode ">
...
<input type="text" name="log" id="form_10955_user_login" class="input" value="" size="20" placeholder="Username or Email..." required />
</div>
<div class="login-field login-password">
<input type="password" name="pwd" id="form_10955_user_pass" class="input" value="" size="20" placeholder="Password..." required />
</div>
...
<input class="remember-checkbox" name="rememberme" type="checkbox" id="form_10955_rememberme" value="forever" />
...
<form name="lostpasswordform" id="form_10955_lostpasswordform" action="https://stadelahly.net/wp-login.php?action=lostpassword" method="post">
...
<div class="rh-p-b">
<div id="form_87876_" class="bs-shortcode bs-login-shortcode ">
<div class="bs-login bs-type-login" style="display:none">
<div class="bs-login-panel bs-login-sign-panel bs-current-login-panel">
<form name="loginform" action="https://stadelahly.net/wp-login.php" method="post">
<div class="login-header">
...
<div class="login-field login-username">
<input type="text" name="log" id="form_87876_user_login" class="input" value="" size="20" placeholder="Username or Email..." required />
</div>
<div class="login-field login-password">
<input type="password" name="pwd" id="form_87876_user_pass" class="input" value="" size="20" placeholder="Password..." required />
</div>
<div class="login-field">
<a href="https://stadelahly.net/wp-login.php?action=lostpassword&redirect_to=https%3A%2F%2Fstadelahly.net%2F" class="go-reset-panel">Forget password?</a>
<span class="login-remember">
<input class="remember-checkbox" name="rememberme" type="checkbox" id="form_87876_rememberme" value="forever" />
<label class="remember-label">Remember me</label>
</span>
</div>
<div class="login-field login-submit">
...
<form name="lostpasswordform" id="form_87876_lostpasswordform" action="https://stadelahly.net/wp-login.php?action=lostpassword" method="post">
<div class="login-field reset-username">
<input type="text" name="user_login" class="input" value="" placeholder="Username or Email..." required />
</div>
<div class="login-field reset-submit">
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam-cell.nr-data.net","licenseKey":"b5df2854a0","applicationID":"355563878","transactionName":"MwBXYEQDVkpSU0IPCwpKdFdCC1dXHEBXAQE=","queueTime":0,"applicationTime":825,"atts":"H0dUFgwZRUQ=","errorBeacon":"bam-cell.nr-data.net","agent":""}</script></body>
</html>