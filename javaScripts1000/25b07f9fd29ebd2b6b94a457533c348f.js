    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'cf2bb198ffe5473bab51cc1a70fc9e03',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_445743989535');
                if (frame) {
...
;np764531("cf2bb198ffe5473bab51cc1a70fc9e03",false);


try{__tagObject_callback_445743989535({ImpressionID:"cf2bb198ffe5473bab51cc1a70fc9e03", ServerPublicDns:"tps812.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "cf2bb198ffe5473bab51cc1a70fc9e03");}catch(e){}
try{__verify_callback_445743989535({
ResultID:2,
Passback:"",
AdWidth:728,
AdHeight:90});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "cf2bb198ffe5473bab51cc1a70fc9e03");}catch(e){}
