...
<head>
    ...
    <link rel="stylesheet" href="/css/production/squareCalendar.min.css?v=G7wZJZA1zcJ5MNghFIonyn9FOkE7KsSRvnbfOysrtZE" />
...
<div class="sherpa sherpa-square-with-calendar dark" style="background: url(https://cdn0.agoda.net/images/sherpa/bg/v2/Sherpa-dark-2-squarecalendar.jpg);  width: 260px;">
    ...
    <div class="bg-overlay ">
        <div class="item-container">
            <section class="content">
                <header>
                    <h1 data-selenium="simple-header" class="title">æ¥è©¢è¨æ¿åªæ </h1>
                    <h3 data-selenium="simple-subheader" class="subtitle">in agoda.com</h3>
                </header>
            </section>
            <div class="search-element search-text">
                <div id="search-keyword-c" data-selenium="simple-input">
                    <input readonly autocomplete="off" id="search-keyword" class="textbox autocomplete calendar-widget-card" type="text" placeholder="&#x8F38;&#x5165;&#x76EE;&#x7684;&#x5730;&#x6216;&#x9152;&#x5E97;&#x540D;&#x7A31;" value="è±è®ç¸£, å°ç£" />
    ...
    <div class="top-panel">
        ...
        <div class="search-element search-text">
            <input autocomplete="off" data-selenium="calendar-search-widget-search-panel-input" id="search-keyword-input" class="textbox autocomplete calendar-widget-card" type="text" value="è±è®ç¸£, å°ç£" />
            <i class="ficon ficon-search-box"></i>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="/js/Production/squareCalendar.min.js?v=mhfVyWVc_Ss-TITxlpv1HUllQUtjaHamgxvev5hs6V0"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var collapsibleOption = new CollapsibleOption($(".room-options .preview"), $(".room-options .collapsible-options"), new CollapsibleOptionCmsItems('å®¢æ¿', 'å®¢æ¿', 'æäºº', 'æäºº', 'å°ç«¥', 'å°ç«¥', 'ä½å®¢', 'ä½å®¢'), settings.occupancy);
