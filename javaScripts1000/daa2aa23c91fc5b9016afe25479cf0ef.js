  ...
  window,
	{
		"nol_GLOBALS":{
            ...
            "nol_osGroup":"",
            "nol_platform":"",
			"nol_clientid":"it-605714","nol_vcid":"c36","nol_clientCMSmap":{"nol_clientid":"clientid","nol_assetName":"(section)","nol_assetid":"assetid","nol_vidtype":"type","nol_vcid":"subbrand"},"nol_sfcode":"it",
			"nol_cidOffsetNull":"00000",
			"nol_emmsfcodelist":["eu","eu-cert","eu-uat","pl","pl-cert","cert","qat4","us","dcr","sdk","dcr-cert","au","it","dmk"],
            ...
            "nol_fbver":"1",
            "nol_appid":"PACC8C20C-3334-4D5D-BAA8-8975B5F22CA4",
...
"",
"",
"|!nol_ocrtag!|&c9=devid,|![nol_deviceId]!|&c8=devgrp,&c29=plid,|![nol_playerId]!|&c30=bldv,|![nol_bldv]!|&c7=osgrp,&c10=plt,&c11=agg,|!nol_aggregate!|&c12=apv,|![nol_appver]!|&c13=asid,PACC8C20C-3334-4D5D-BAA8-8975B5F22CA4&c14=osver,NA&c26=dmap,3&c24=zip,99&uoo=|![nol_useroptout]!|&c68=bndlid,&c61=createtm,|![nol_createTime||nol_pingCreationTime]!|&c62=sendTime,|![nol_sendTime]!|&nodeTM=|![nol_nodetm]!|&logTM=|![nol_logtm]!|&c73=phtype,&c74=dvcnm,&sdd=retry,|![(nol_retry)]!|~~retryreason,|![(nol_retryReason)]!|~~devmodel,|![(nol_devmodel)]!|~~devtypid,|![(nol_devtypeid)]!|~~sysname,|![(nol_sysname)]!|~~sysversion,|![(nol_sysversion)]!|~~manuf,|![(nol_manuf)]!|",
"",
"",
"",
"",
