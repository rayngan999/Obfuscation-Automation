(function (cc) {
    ...
    cc.Popup = (function () {
        ...
        var defaultOptions = {
            ...
            window: '<div role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc" id="cc-cookieconsent-generic" class="cc-window {{classes}}"><!--googleoff: all-->{{children}}<!--googleon: all--></div>',
        ...
        function appendMarkup(markup) {
            ...
            if (opts.autoAttach) {
                if (!cont.firstChild) {
                    ...
                    cont.appendChild(el, cont.firstChild);
                }
            }
    ...
    cc.initialise = function (options, complete, error) {
        ...
        if (!complete) complete = function (popup) { };
        if (!error) error = function (error,popup) { };
