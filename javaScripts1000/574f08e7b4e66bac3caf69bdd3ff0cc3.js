    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'39d1bfe19e6b4d0c95dd4dd951959235',
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_375896422844');
                if (frame) {
...
;np764531("39d1bfe19e6b4d0c95dd4dd951959235",false);


try{__tagObject_callback_375896422844({ImpressionID:"39d1bfe19e6b4d0c95dd4dd951959235", ServerPublicDns:"tps810.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "39d1bfe19e6b4d0c95dd4dd951959235");}catch(e){}
try{__verify_callback_375896422844({
ResultID:2,
Passback:"",
AdWidth:728,
AdHeight:90});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "39d1bfe19e6b4d0c95dd4dd951959235");}catch(e){}
