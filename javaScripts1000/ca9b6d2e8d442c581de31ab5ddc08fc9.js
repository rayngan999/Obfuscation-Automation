...
.text_1 {left: 14px;top: 150px;}
.text_1 img {max-width: 121px;}
.text_2 {left: 16px;top: 150px;}
.text_2 img {max-width: 94px;}
.text_3 {left: 13px;top: 156px;}
.text_3 img {max-width: 135px;}

.btn_main {left: 16px; top: 243px; width: 102px; height: 32px;transition: 0.3s; -webkit-transition: 0.3s; -moz-transition: 0.3s; -o-transition: 0.3s;}
