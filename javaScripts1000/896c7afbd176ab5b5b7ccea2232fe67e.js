            ...
            <div class="account-content-container">
                <div class="account-table-body">
                    ...
                    <section class="account-section">
                                    ...
                                    <form class="pay-transfer-options clearfix" action="https://www4.citizensbankonline.com/efs/servlet/efs/default.jsp" name="SignOn" id="frmSignOn" method="post">
                                    ...
                                    <input type="hidden" name="CSRF_TOKEN" value="E1KA-D8J2-08SE-94GW-9INI-MOTS-54XZ-J1PS"/>
