...
.banner-box { cursor: pointer; margin: 0; padding: 0; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; position: relative; width: 160px; height: 600px; overflow: hidden; background: linear-gradient(174.63deg, rgba(43, 212, 219, 0) 18.96%, rgba(43, 212, 219, 0.2) 90.8%), #0C1142;}
.all_frame {width: 100%; height: 100%; left: 0; top: 0; position: absolute;}
.all_frame div {position: absolute;}

.main_bg {right: 0px;bottom: 0px;}
.main_bg img {max-width: 160px;}
.logo {left: 15px;top: 21px;}
.logo img {max-width: 90px;}
.text_1 {left: 17px;top: 170px;}
.text_1 img {max-width: 114px;}
.text_2 {left: 17px;top: 170px;}
.text_2 img {max-width: 120px;}
.text_3 {left: 13px;top: 169px;}
.text_3 img {max-width: 135px;}

.btn_main {left: 16px; top: 257px; width: 102px; height: 32px;transition: 0.3s; -webkit-transition: 0.3s; -moz-transition: 0.3s; -o-transition: 0.3s;}
...
.btn_main a span {left: 15px; top: 10px; position: absolute;}
