...
b.prototype.wa=function(g){if(g===this)this.m(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.ya(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.ca(g):this.o(g)}};
b.prototype.ca=function(g){var h=void 0;try{h=g.then}catch(k){this.m(k);return}"function"==typeof h?this.za(h,g):this.o(g)};
...
var f=new c;b.prototype.ya=function(g){var h=this.l();g.W(h.resolve,h.reject)};
...
mf.prototype.start=function(){var a=B("yt.scheduler.instance.start");a&&a()};mf.h||(mf.h=new mf);function of(a){var b=pf;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=xc;e.flash="0";a:{try{var f=b.h.top.location.href}catch(oa){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?J:g;try{var h=g.history.length}catch(oa){h=0}e.u_his=h;e.u_java=!!J.navigator&&"unknown"!==typeof J.navigator.javaEnabled&&!!J.navigator.javaEnabled&&J.navigator.javaEnabled();J.screen&&(e.u_h=J.screen.height,e.u_w=J.screen.width,
e.u_ah=J.screen.availHeight,e.u_aw=J.screen.availWidth,e.u_cd=J.screen.colorDepth);J.navigator&&J.navigator.plugins&&(e.u_nplug=J.navigator.plugins.length);J.navigator&&J.navigator.mimeTypes&&(e.u_nmime=J.navigator.mimeTypes.length)}catch(oa){}h=b.h;try{var k=h.screenX;var l=h.screenY}catch(oa){}try{var m=h.outerWidth;var q=h.outerHeight}catch(oa){}try{var t=h.innerWidth;var p=h.innerHeight}catch(oa){}try{var x=h.screenLeft;var A=h.screenTop}catch(oa){}try{t=h.innerWidth,p=h.innerHeight}catch(oa){}try{var v=
h.screen.availWidth;var K=h.screen.availTop}catch(oa){}k=[x,A,k,l,v,K,m,q,t,p];l=b.h.top;try{var P=(l||window).document,E="CSS1Compat"==P.compatMode?P.documentElement:P.body;var N=(new lc(E.clientWidth,E.clientHeight)).round()}catch(oa){N=new lc(-12245933,-12245933)}P=N;N={};E=new Jc;z.SVGElement&&z.document.createElementNS&&E.set(0);l=wc();l["allow-top-navigation-by-user-activation"]&&E.set(1);l["allow-popups-to-escape-sandbox"]&&E.set(2);z.crypto&&z.crypto.subtle&&E.set(3);z.TextDecoder&&z.TextEncoder&&
...
dbName:b});if("AbortError"===d.name)return new V("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},d.message);d.args=[{name:"IdbError",lb:d.name,dbName:b,objectStoreNames:c}];d.level="WARNING";return d}
...
;function ah(a,b,c){function d(){c(a.error);f()}
...
;function ch(a,b){return new W(new Wg(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()}))}
...
function eh(a,b,c,d){return I(a,function f(){var g=this,h,k,l,m,q,t,p,x,A,v,K,P;return y(f,function(E){switch(E.h){case 1:var N={mode:"readonly",D:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?N.mode=c:Object.assign(N,c);h=N;g.transactionCount++;k=h.D?3:1;l=0;case 2:if(m){E.v(3);break}l++;q=Math.round(R());sa(E,4);t=g.h.transaction(b,h.mode);N=new jh(t);N=kh(N,d);return w(E,N,6);case 6:return p=E.i,x=Math.round(R()),lh(g,q,x,l,void 0,b.join(),h),E.return(p);case 4:A=ta(E);v=Math.round(R());
...
function kh(a,b){var c=new Promise(function(d,e){try{Xg(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
...
function qh(a){return X(a).then(function(b){return b?new sh(a,b):null})}
...
n.update=function(a){return X(this.cursor.update(a))};function th(a,b,c){return new Promise(function(d,e){function f(){t||(t=new dh(g.result,{closed:q}));return t}
...
function vh(a,b){b=void 0===b?{}:b;return I(this,function d(){var e,f,g;return y(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return w(h,bh(e),0)})})}
...
wh.prototype.open=function(){function a(){return I(c,function g(){var h=this,k,l,m,q,t;return y(g,function(p){switch(p.h){case 1:return sa(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var x=h.options;for(var A=u(Object.keys(x.ha)),v=A.next();!v.done;v=A.next()){v=v.value;var K=x.ha[v],P=void 0===K.sa?Number.MAX_VALUE:K.sa;if(k.h.version>=K.da&&!(k.h.version>=P)&&!k.h.objectStoreNames.contains(v)){x=v;break a}}x=void 0}l=x;if(void 0===l){p.v(5);break}if(h.j){p.v(6);break}h.j=!0;return w(p,
...
closed:b,Ra:b,upgrade:this.options.upgrade};return this.h=d=a()};var yh=new wh("YtIdbMeta",{ha:{databases:{da:1}},upgrade:function(a,b){b(1)&&gh(a,"databases",{keyPath:"actualName"})}});
...
;new function(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})};function Gh(a){try{Kg();var b=!0}catch(c){b=!1}if(!b)throw a=new V("AUTH_INVALID",{dbName:a}),Hg(a),a;b=Kg();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function Hh(a,b,c,d){return I(this,function f(){var g,h,k,l;return y(f,function(m){switch(m.h){case 1:return w(m,Fh(),2);case 2:g=m.i;if(!g)throw h=Tg("openDbImpl",a,b),Hg(h),h;Lg(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:Gh(a);sa(m,3);return w(m,zh(k),5);case 5:return w(m,uh(k.actualName,b,d),6);case 6:return m.return(m.i);case 3:return l=ta(m),sa(m,7),w(m,Ah(k.actualName),9);case 9:m.h=8;m.o=0;break;case 7:ta(m);case 8:throw l;}})})}
...
function Ph(){if(Oh)return Oh();var a={};Oh=Nh({ha:(a.LogsRequestsStore={da:2},a.SWHealthLog={da:3,sa:9},a),va:!1,upgrade:function(b,c,d){c(2)&&gh(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3)&&gh(b,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1});c(5)&&(d=fh(d,"LogsRequestsStore"),d.h.indexNames.contains("newRequest")&&d.h.deleteIndex("newRequest"),d.h.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));
...
function Sh(){return I(this,function b(){var c,d,e,f,g,h,k;return y(b,function(l){if(1==l.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,Ph().open(),2);if(3!=l.h)return d=l.i,e=O("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=["NEW",e,0],g=["NEW",e,R()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,eh(d,["LogsRequestsStore"],{mode:"readwrite",D:!0},function(m){return rh(fh(m,"LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(q){q.cursor.value&&(k=q.cursor.value,
...
Y.prototype.sendNetworkCheckRequest=Y.prototype.L;Y.prototype.listen=Y.prototype.Z;Y.prototype.enableErrorFlushing=Y.prototype.Fa;Y.prototype.getWindowStatus=Y.prototype.ea;Y.prototype.monitorNetworkStatusChange=Y.prototype.Qa;Y.prototype.isNetworkAvailable=Y.prototype.J;Y.getInstance=bi;function di(a){a=void 0===a?{}:a;L.call(this);var b=this;this.l=this.u=0;this.i=bi();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Ga);a.Oa&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.i))a.ba?(this.ba=a.ba,c("ytnetworkstatus-online",function(){ei(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){ei(b,"publicytnetworkstatus-offline")})):
...
function ei(a,b){a.ba?a.l?(nf(a.u),a.u=lf(function(){a.o!==b&&(Td(a,b),a.o=b,a.l=R())},a.ba-(R()-a.l))):(Td(a,b),a.o=b,a.l=R()):Td(a,b)}
;var fi=0,gi=0,hi,ii=z.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1,Da:void 0,potentialEsfErrorCounter:gi,isIdbSupported:!1};Q("export_networkless_options")&&D("ytNetworklessLoggingInitializationOptions",ii);function ji(a,b){function c(d){var e=ki().J();if(!li()||!d||e&&Q("vss_networkless_bypass_write"))mi(a,b);else{var f={url:a,options:b,timestamp:R(),status:"NEW",sendCount:0};Qh(f).then(function(g){f.id=g;ki().J()&&ni(f)}).catch(function(g){ni(f);
ki().J()?Le(g):Yh(g)})}}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?Fh().then(function(d){c(d)}):c(oi())}
function pi(a,b){function c(d){if(li()&&d){var e={url:a,options:b,timestamp:R(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(h,k){void 0!==e.id?Vh(e.id):f=!0;g(h,k)};
mi(e.url,e.options);Qh(e).then(function(h){e.id=h;f&&Vh(e.id)}).catch(function(h){ki().J()?Le(h):Yh(h)})}else mi(a,b)}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?Fh().then(function(d){c(d)}):c(oi())}
...
function ri(a){var b=this;if(!oi())throw Tg("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){return I(b,function h(){return y(h,function(k){switch(k.h){case 1:if(!((B("ytNetworklessLoggingInitializationOptions")?ii.potentialEsfErrorCounter:gi)<=gf("potential_esf_error_limit",10))){k.v(2);break}return w(k,ki().L(),3);case 3:if(ki().J())B("ytNetworklessLoggingInitializationOptions")&&ii.potentialEsfErrorCounter++,gi++;else return c(e,f),k.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){k.v(4);break}return 1>a.sendCount?w(k,Uh(a.id),8):w(k,Vh(a.id),
...
c.onFetchSuccess=function(v,K){zg(p);A(v,K)}}try{t&&d.retry&&!d.qa.bypassNetworkless?(g.method="POST",d.qa.writeThenSend?ji(q,g):pi(q,g)):(g.method="POST",g.postParams||(g.postParams={}),xf(q,g))}catch(v){if("InvalidAccessError"==v.name)p&&(zg(p),p=0),Me(Error("An extension is blocking network request."));
...
;function ti(a,b){var c=void 0===c?{}:c;var d=si;O("ytLoggingEventsDefaultDisabled",!1)&&si==si&&(d=null);c=void 0===c?{}:c;var e={},f=Math.round(c.timestamp||R());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=B("_lact",window);a=null==a?-1:Math.max(Date.now()-a,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};Q("log_sequence_info_on_gel_web")&&c.ta&&(a=e.context,b=c.ta,ng[b]=b in ng?ng[b]+1:0,a.sequence={index:ng[b],groupKey:b},c.ib&&delete ng[c.ta]);(c.nb?gg:cg)({endpoint:"log_event",
payload:e,H:c.H,X:c.X},d)}
;var ui=[{ga:function(a){return"Cannot read property '"+a.key+"'"},
...
aa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var wi={K:[],I:[{Ba:vi,weight:500}]};function vi(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
;var Ai=new M;function Bi(a){function b(){return a.charCodeAt(d++)}
...
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Hb(a.src):"https://www.youtube.com"),this.i=new Ui(b),c||(b=cj(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ia(this.h)),Oi[this.h.id]=this,window.postMessage){this.l=new M;dj(this);b=Z(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Qi)Qi.hasOwnProperty(e)&&
aj(this,e)}};
...
g)}if(!(5<=Hi)){g=void 0;var k=f,l=dd(e);f=l.message||"Unknown Error";h=l.name||"UnknownError";var m=l.stack||e.i||"Not available";if(m.startsWith(h+": "+f)){var q=m.split("\n");q.shift();m=q.join("\n")}q=l.lineNumber||"Not available";l=l.fileName||"Not available";var t=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(t=Di(e.args[g],"params."+g,k,t),500<=t);g++);else if(e.hasOwnProperty("params")&&e.params){var p=e.params;if("object"===typeof e.params)for(g in p){if(p[g]){var x=
"params."+g,A=Fi(p[g]);k[x]=A;t+=x.length+A.length;if(500<t)break}}else k.params=Fi(p)}if(Ki.length)for(g=0;g<Ki.length&&!(t=Di(Ki[g],"params.context."+g,k,t),500<=t);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:q,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=zi();f=u(e.K);for(h=f.next();!h.done;h=f.next())if(h=h.value,
g.message&&g.message.match(h.kb)){e=h.weight;break a}e=u(e.I);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.Ba(g)){e=f.weight;break a}e=1}g.sampleWeight=e;e=g;g=u(ui);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.aa[e.name])for(q=u(f.aa[e.name]),h=q.next();!h.done;h=q.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];q=l.groups;l={};for(m=0;m<q.length;m++)l[q[m]]=h[m+1],e.params["params.error."+q[m]]=h[m+1];e.message=f.ga(l);break}e.params||(e.params={});
g=zi();e.params["params.errorServiceSignature"]="msg="+g.K.length+"&cb="+g.I.length;e.params["params.serviceWorker"]="false";z.document&&z.document.querySelectorAll&&(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));hb("sample").constructor!==fb&&(e.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!Gi.has(e.message)){"ERROR"===d?(Ai.O("handleError",e),Q("record_app_crashed_web")&&0===
Ji&&1===e.sampleWeight&&(Ji++,ti("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),Ii++):"WARNING"===d&&Ai.O("handleWarning",e);if(Q("kevlar_gel_error_routing")){g=d;l=e;b:{f=u(Li);for(h=f.next();!h.done;h=f.next())if(Gf(h.value.toLowerCase())){f=!0;break b}f=!1}if(f)f=void 0;else{h={stackTrace:l.stack};l.fileName&&(h.filename=l.fileName);f=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==f.length&&(1!==f.length||isNaN(Number(f[0]))?2!==f.length||isNaN(Number(f[0]))||isNaN(Number(f[1]))||
...
k,value:String(l[k])});l=O("SERVER_NAME",void 0);m=O("SERVER_VERSION",void 0);l&&m&&(q.kvPairs.push({key:"server.name",value:l}),q.kvPairs.push({key:"server.version",value:m}));f={errorMetadata:q,stackTrace:h,logMessage:f}}f&&(ti("clientError",f),("ERROR"===g||Q("errors_flush_gel_always_killswitch"))&&eg())}if(!Q("suppress_error_204_logging")){f=e;g=f.params||{};d={urlParams:{a:"logerror",t:"jserror",type:f.name,msg:f.message.substr(0,250),line:f.lineNumber,level:d,"client.name":g.name},postParams:{url:O("PAGE_NAME",
...
f)}xf(O("ECATCHER_REPORT_HOST","")+"/error_204",d)}Gi.add(e.message);Hi++}}}}}else throw v;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function ej(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
function ij(a,b){G(b,function(c){this[c]||("getCurrentTime"===c?this[c]=function(){var d=this.playerInfo.currentTime;if(1===this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:ej(c)?this[c]=function(){this.playerInfo={};
this.F={};bj(this,c,arguments);return this}:fj(c)?this[c]=function(){var d=0;
0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){bj(this,c,arguments);
return this})},a)}
...
Pi.push(function(a){var b=a;b||(b=document);a=Wa(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var f={};for(c=d=0;b=e[c];c++){var g=b.className,h;if(h="function"==typeof g.split)h=0<=Sa(g.split(/\s+/),
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=Wa(b);G(Va(a,b),jj)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Ri();var kj=z.onYTReady;kj&&kj();var lj=z.onYouTubeIframeAPIReady;lj&&lj();var mj=z.onYouTubePlayerAPIReady;mj&&mj();}).call(this);
