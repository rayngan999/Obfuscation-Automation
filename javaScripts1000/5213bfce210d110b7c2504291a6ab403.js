(function () {
  ...
  window.adroll_seg_eid = "K4XWHDX74NGY7LLB3I4LOW";
  var rule = ["*", "*"];
  ...
  var cm_urls = ["/cm/r/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/b/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/x/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/l/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/o/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/g/out?advertisable=R5SW7T3VQBDB5LRMR673KZ&google_nid=adroll5"];
...
rtb.innerHTML = ["/cm/index/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/n/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/onevideo/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/outbrain/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/pubmatic/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/r/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/taboola/out?advertisable=R5SW7T3VQBDB5LRMR673KZ","/cm/triplelift/out?advertisable=R5SW7T3VQBDB5LRMR673KZ"].reduce(function (acc, cmURL) {
...
(function(){
    ...
    fbq('init', '208334076619845');
    fbq('set', 'autoConfig', 'false', '208334076619845');
    __adroll.fb=true;

    var __fbcd = {segment_eid: "K4XWHDX74NGY7LLB3I4LOW,WFMUTPTFUBBVZISRFQJSFF"};
    ...
    var __fbcd = {event: "EventSegment", segment_eid: "K4XWHDX74NGY7LLB3I4LOW,WFMUTPTFUBBVZISRFQJSFF"};
    for (var prop in __adroll.get_external_data()){
        __fbcd['ar_' + prop] = __adroll.get_external_data()[prop];
    }
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "K4XWHDX74NGY7LLB3I4LOW");}
}());
