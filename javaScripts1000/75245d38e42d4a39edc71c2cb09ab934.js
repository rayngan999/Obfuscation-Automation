...
ClickTaleGlobal.scripts.versions = {"wr": "latest-WR110.js", "pcc": "e703b240-18af-4061-bc09-77b9bcde58a2.js?DeploymentConfigName=Release_20210506&Version=3"};
(function (d) {
	var dom="h",
	...
	ClickTaleGlobal.init.isAllowed = (function() {
						var doms = ["HLyVwVZaHsLhJVT","HLyVwVZaHsLhkLTHukDHyLhuLa","kLTHukDHyLhuLa","uHBaPJHhJVT","RPwsPuNABZHhJVT","uHBaPJHhJVT","ZaHNPuNADLiZaVyLAHLyVwVZaHsLhkLTHukDHyLhuLa","RPwsPuNhJVT","uHBaPJHhJVT"];
...
window.ClickTaleUIDCookieName = 'WRUID20190128';
...
;
(function () {
    var selectorForBoth = 'selector, #suggested-address-1 p, #entered-address p, div.shipping-text div';
    var labelTextSelector = ".address > div, .details > div, .redemption.coupon.form-row > span.success, .coupon-error, .payment-method input, .payment-method select, .payment-method select > option, .order-information-description > div, .mini-address-location > address, .form-row > span";
    var addressValueSelector="select#dwfrm_billing_addressList option, #same-as-shipping";
    var dataNameSelector = "div.data-name";
    var dataAddressSelector = "div.data-address1";
    var dataCountrySelector = "div.data-country";
    var dataCityPostalSelector = "div.data-city-state-postal";
    ...
    ClickTaleSettings.DOM.PII = {
        Text: [selectorForBoth, labelTextSelector, addressValueSelector, dataNameSelector, dataAddressSelector, dataCountrySelector, dataCityPostalSelector],
        Attributes: [{
            rule: selectorForBoth,
            attr: 'value'
        },{
            rule: labelTextSelector,
            attr: 'label'
        },{
            rule: addressValueSelector,
            attr: 'value'
        },{
            rule: addressValueSelector,
            attr: 'data-address'
        ...
        ,{
            rule: dataAddressSelector,
            attr: 'data-address1'
        },{
            rule: dataCountrySelector,
            attr: 'data-country'
        },{
            rule: dataCityPostalSelector,
            attr: 'data-postal'
        },{
            rule: dataCityPostalSelector,
            attr: 'data-city'
...
function ClickTaleOnRecording() {
    ...
    if (!window.ClickTaleSettings.PTC.GAReady) {
        window.ClickTaleSettings.PTC.GAReady = true;
        ...
        var clickTaleGAgetTrackerName;
 
        function clickTaleGASendBeacon(event) {
            ...
            for (var i = 0; i < clickTaleGAgetTrackerName.length; i++) {
                if (typeof clickTaleGAgetTrackerName[i].get('name') === 'string' && clickTaleGAgetTrackerName[i].get('name') != '' && typeof clickTaleGAgetTrackerName[i].get('trackingId') === 'string' && clickTaleGAgetTrackerName[i].get('trackingId') != '') {
                    if (clickTaleGAgetTrackerName[i].get('trackingId') === 'UA-64202560-1') {
                        if (event && event === 'sendUID') {
                            ga(clickTaleGAgetTrackerName[i].get('name') + '.send', 'event', 'Clicktale', 'UID', '', {
                                'dimension20': ClickTaleGetUID().toString(),
                                'nonInteraction': 1
                            });
                        }
                        ga(clickTaleGAgetTrackerName[i].get('name') + '.send', 'event', 'Clicktale', 'SID', '', {
                            'dimension21': ClickTaleGetSID().toString(),
                            'nonInteraction': 1
                        });
                    }
                }
        ...
        function clickTaleGAIntegration() {
            ...
            if (typeof clickTaleGAgetTrackerName != 'undefined' && typeof clickTaleGAgetTrackerName != null && typeof clickTaleGAgetTrackerName === 'object' && clickTaleGAgetTrackerName.length > 0 && clickTaleGAgetTrackerName[0].get('name') != '' && typeof clickTaleReadCookie === 'function') {
...
if(!ClickTaleGlobal.init.pccRequested) {
	    ...
	    pccSrc += 'e703b240-18af-4061-bc09-77b9bcde58a2.js?DeploymentConfigName=Release_20210506&Version=3';
...
window.ClickTaleSettings.PTC.CustomVariables = [
    { displayName: 'Page Name', key: 'page_name', slot: 1 },
];

function sendCVar() {
    var dataGetObj = window['utag_data'];
    if (!!dataGetObj) {
...
window.ClickTaleSettings.PTC.doOnlyWhen(doUpload, isReadyToRecord, 500, 12, doUpload);
...
//Signature:cT5izVPficqXruXFzCa22oHEQZDL3EfaeDOSX3aBxbeTsBpe8T+p4ZySLzyWkQxMuwwRnjnbaMBF5wPZttdVBD5IA8J2dwrjIdva+m8BIaoE6XEG8JScqu7ZfQec3hcgC+BmnRMM48Gu7eHi8SyeTM2B5bFnT43hGNgf/4gUTS8=