(function jvxPixelWrapper(){
    ...
    var existingData = [];
    var existingGroups = {};
    var pixelParams = {"enteringBrand":"GAP_CA","productId":"","productIdsCart":"","productQtyCart":"","pricesInCart":"","px":"160de096ce7871","pageName":"gp:browse:Home","pageType":"Home","productSkusCart":"","productBrandsCart":"","currency":"CAD","cData":"Gap","categoryId":""};
    var gdprParams = "";
    var addnlPixelData = function getRetargetingData() {
   // refer to help link for more options
 return   [pixelParams.cData];
 };
    var partnerSyncPixels = {"lotame":"https://sync.jivox.com/tags/sync/usync.php?px=1utAfZ8i&src=re&id=160de096ce7871&&"};
