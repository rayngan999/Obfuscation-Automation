...
b.push((c==window.top?-1:1)*e)};try{return function(){for(var b=window,d=0;10>d&&(c(b),b!=window.top);d++)try{b.parent.document&&(b=b.parent)}catch(l){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(f){return{vdcv:28,vdcd:"-999",err:f.message||"unknown"}}}function S(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function T(b,c,e){try{var d;if(!(d=e.ID==$dvbs.Enums.BrowserId.IE)){if(b==window._dv_win.top)var f=$dvbs.Enums.TrafficScenario.OnPage;else{e=b;try{for(var n=0;window._dv_win.top!=
e&&10>=n;){var l=e.parent;if(!l.document)break;e=l;n++}}catch(V){}f=e==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}d=f!=$dvbs.Enums.TrafficScenario.CrossDomain}if(d)return null;b.performance&&b.performance.mark&&b.performance.mark("dv_str_html_start");if(c){var k=c.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(k&&0<k.length)return null}var h=b.document;if(h&&h.referrer){var q=h.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),
p=new RegExp('(?:w{0,4}=")?'+q+"[^&\"; %,'\\$\\\\\\|]+","gi");c=/banner|adprefs|safeframe|sandbox|sf\.html/gi;d=/^\w{0,4}="/gi;var A=J(h,"script","src",p,c,d);if(!A){var r=h.referrer;f="";var t=h.getElementsByTagName("script");if(t)for(l=0;!f&&l<t.length;){var g=t[l].innerHTML;if(g&&-1!=g.indexOf(r)){var y=g.match(p);f=K(y,c,d)}l++}(A=f)||(A=J(h,"a","href",p,c,d))}h=htmlUrl=A;a:{if(b.performance&&b.performance.mark&&b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");
