//Generated:2021-07-14 12:37:52// 6-252
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4215037 || '',
    guid: window.ftGUID_4215037 || '',
    confID: window.ftConfID_4215037 || '0',
    ftReturn: window.ftReturn_4215037 || '',
    keyword: window.ftKeyword_4215037 || '',
    ftId: window.ftId_4215037 || '',
    ftImpId: window.ftImp4215037 && window.ftImp4215037.impID || '',
    gdpr: window.ftImp4215037 && window.ftImp4215037.gdpr || '',
    gdpr_consent: window.ftImp4215037 && window.ftImp4215037.gdpr_consent || '',
    gdpr_pd: window.ftImp4215037 && window.ftImp4215037.gdpr_pd || '',
    us_privacy: window.ftImp4215037 && window.ftImp4215037.us_privacy || '',
    campaignID: '115843',
    cID: '100966',
    pID: '4215037',
    creativeID: '3482297',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4215037&num=&adid=&advid=&adsrv=29&btreg=4215037&btadsrv=flashtalking&crt=3482297&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ["http://servedby.flashtalking.com/click/8/115843;4215037;3482297;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/hk_en/creativecloud/plans.html?sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?208619476-4215037;3482297;',
    centreAd: false,
    width: 300,
    height: 250,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/421/4215037/3482297/image/3482297.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115843;4215037;202;pixel;DV360;DV360FY20CCBEHCustomAffinityHKDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: "http://servedby.flashtalking.com/click/8/115843;4215037;3482297;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/hk_en/creativecloud/plans.html?sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4215037',
    altimgID: 'ftalt4215037',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4215037 && parseInt(window.ftImp4215037.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4215037') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4215037'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4215037").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4215037").style.display = "none";
		    }
		});
	}
}(ft4215037));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115843&l2=DV360&l3=4215037&l4=3482297&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115843&l2=DV360&l3=4215037&l4=3482297&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
