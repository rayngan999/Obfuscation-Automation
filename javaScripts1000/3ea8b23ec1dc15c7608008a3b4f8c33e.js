...
// EXTERNAL MODULE: /drone/src/github.com/Vidyard/vidyard-player-sdk/node_modules/makeup-screenreader-trap/index.js
...
function setEventListeners(player, callback, thresholdList) {
    ...
    var onBeforeSeek = function (time) {
        var chapter = player.getCurrentChapter();
        // on Safari beforeSeek can fire before play Â¯\_(ã)_/Â¯
        if (typeof intervalList[chapter] === 'undefined') {
            return;
        }
        if (lock === false) {
