...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|Q|o|B|q'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|H|h|G|f'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|w|p|q|W'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|w|p|q|W'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|X|e|V|c'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('0=0.2(/3/1,\'6\').2(/5/1,\'4\');',7,7,'LR_LFBH|g|replace|Q|o|B|q'.split('|'),0,{}));var lr_para2 = LR_LFBH,lr_para0 = '24|11|3|17|21|15|7|6|20|23|2|22|4|5|31|0|8|28|16|9|18|25|29|12|13|27|30|1|19|10|14|26',lr_para1 = '',lr_para3 = '',lr_para4 = '';eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('2=1 0().3();6=5.4("|");',7,7,'daf723b97b6|new|lr_para1|g|split|lr_para0|lr_para4'.split('|'),0,{}));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?"":e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1;};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p;}('3 1$=["\\4\\6\\8\\4\\9\\7"];5(3 a=b;a<f;a++){g+=e[1$[0]](a,2)+c[1$[0]](d[a],2)}',17,17,'|_|0x1|var|x73|for|x75|x72|x62|x74||0x0|lr_para2|lr_para4|lr_para1|0x20|lr_para3'.split('|'),0,{}));if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_invitestring=unescape("%3cP style%3d%22FONT-SIZE%3a 9pt%22%3e%u60a8%u597d%uff0c%u6b22%u8fce%u60a8%uff01%u5982%u679c%u60a8%u6709%u4efb%u4f55%u95ee%u9898%uff0c%u8bf7%u63a5%u53d7%u6b64%u9080%u8bf7%uff0c%u6211%u4f1a%u7ed9%u4f60%u66f4%u591a%u66f4%u597d%u7684%u534f%u52a9%uff01%3c%2fP%3e");
...
var LR_c138='';var LR_c139='';var LR_c140='';	if('0'=='1'){LR_showfloat=0;}
	var _lr_helpsrc_on=unescape("http://pht.zoosnet.net/site/92664255/offlineimgsrc_cn.jpg");
	var _lr_helpalt_on=unescape("%u5982%u679c%u60a8%u6709%u4ec0%u4e48%u95ee%u9898%uff0c%u8bf7%u70b9%u51fb%u5373%u65f6%u6c9f%u901a");
	var _lr_helpsrc_of=unescape("http%3a%2f%2fpht.zoosnet.net%2fsite%2f92664255%2fofflineimgsrc_cn.jpg");
	var _lr_helpalt_of=unescape("%u5ba2%u670d%u79bb%u7ebf%uff0c%u8bf7%u70b9%u51fb%u6b64%u5904%u7559%u8a00%uff01%u6211%u4eec%u4f1a%u5c3d%u5feb%u7b54%u590d");
	var _lr_closesrc0='2.gif';
	var _lr_toright=((typeof(LiveReceptionCode_ToRight)!='undefined')?LiveReceptionCode_ToRight:0);
	var _lr_left=((typeof(LiveReceptionCode_helpimgleft)!='undefined')?LiveReceptionCode_helpimgleft:50);
	var _lr_tobottom=((typeof(LiveReceptionCode_ToBottom)!='undefined')?LiveReceptionCode_ToBottom:0);
	var _lr_top=((typeof(LiveReceptionCode_helpimgtop)!='undefined')?LiveReceptionCode_helpimgtop:220);
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	...
	data+='&r='+lr_refer5237;
	data+='&e='+escape(LR_explain)+'&MFBI=FCAD&MGBI=GCAE&NGCJ=GDBE&CFIL='+ lr_para3 + '&s=' + LR_sSize;
...
var _lr_form_show = 0;//è¡¨åæ¯å¦æå¼
    ...
    switch (_lr_form_id) {
        case "fname":
            if (_lr_form_value.length > 20) {
                _lr_return = "å§åä¸è½è¶è¿20ä¸ªå­ç¬¦";
            }
            break;
        case "fage":
            var regNum = /^[0-9]{1,2}$/;
            if (!regNum.test(_lr_form_value)) {
                _lr_return = "è¯·è¾å¥æ­£ç¡®çå¹´é¾ï¼";
            }
            break;
        case "fwechat":
            if (_lr_form_value.length > 50) {
                _lr_return = "å¾®ä¿¡å·ç ä¸è½è¶è¿50ä¸ªå­ç¬¦";
            }
            break;
        case "fqq":
            var regNum = /^[1-9][0-9]{4,14}$/;
            if (!regNum.test(_lr_form_value)) {
                _lr_return = "è¯·è¾å¥æ­£ç¡®çQQï¼";
            }
            break;
        case "fmobile":
            var regNum = /^[1-9][0-9]{10}$/;
            if (!regNum.test(_lr_form_value)) {
                _lr_return = "è¯·è¾å¥æ­£ç¡®ççµè¯ï¼";
            }
            break;
        case "ftel":
            var regNum = /^[0-9|-]*$/;
            ...
            if (eForm.children[i].getElementsByTagName("input").length > 0) {
                ...
                if (strCheck == "1") {
                    if (strValue.length == 0) {
                        bCheck = false;
                        eFormEle.placeholder = "è¯·è¾å¥" + strTitle;
