...
function get_strokeText(string,x,y,size,weight,width,space,font,color,opacity,rotation,id) {
	...
	for(i=0; i<len; i++) { if(string.charAt(i)>'Ã¿') {c=strokeFont[font][string.charCodeAt(i)];}else {c=strokeFont[font][string.charAt(i)];} if(!c) {continue;} o=0; 
...
function get_textWidth(string,size,width,space,font) {
	...
	for(var i=0,c=''; i<len; i++) {if(string.charAt(i)>'Ã¿') {c=strokeFont[font][string.charCodeAt(i)];}else {c=strokeFont[font][string.charAt(i)];} if(c) total+=((c.w*fw)*mg)+m;}return total-(m);
}
function get_widthText(string,width,size,fontwidth,space,font) {
	...
	for(var i=0,c=''; i<len; i++) {if(string.charAt(i)>'Ã¿') {c=strokeFont[font][string.charCodeAt(i)];}else {c=strokeFont[font][string.charAt(i)];} if(c) {cur=((c.w*fw)*mg)+m; if((total+cur-(m))<=width) {total+=cur;}else {break; }}else {break; }} return string.substring(0,i); 
}
...
function do_drawText(string,x,y,size,weight,width,space,font) {
	...
	for(i=0; i<len; i++) {if(string.charAt(i)>'Ã¿') {c=strokeFont[font][string.charCodeAt(i)];}else {c=strokeFont[font][string.charAt(i)];} if(!c) {continue;} o=0; this.beginPath(); 
		for(j=0; j<c.n; j++) {if(typeof(c.d[o])!="string") {o++; continue;} p=c.d[o]; o++; a=c.d[o];
...
strokeFont["sans-serif"] = {
	...
	'Ã': {w:19,n:8,d:['m',[7,25],'l',[10,23],'m',[17,21],'l',[4,21],[4,0],[17,0],'m',[4,11],'l',[12,11]]},
	'Ã': {w:19,n:8,d:['m',[9,23],'l',[12,25],'m',[17,21],'l',[4,21],[4,0],[17,0],'m',[4,11],'l',[12,11]]},
	'Ã': {w:19,n:8,d:['m',[8,23],'l',[10,25],[12,23],'m',[17,21],'l',[4,21],[4,0],[17,0],'m',[4,11],'l',[12,11]]},
	'Ã': {w:19,n:10,d:['m',[6,25],'l',[6,23],'m',[15,25],'l',[15,23],'m',[17,21],'l',[4,21],[4,0],[17,0],'m',[4,11],'l',[12,11]]},
	'Ã': {w:8,n:4,d:['m',[3,25],'l',[6,23],'m',[4,21],'l',[4,0]]},
	'Ã': {w:8,n:4,d:['m',[2,23],'l',[5,25],'m',[4,21],'l',[4,0]]},
	'Ã': {w:8,n:4,d:['m',[2,23],'l',[4,25],[6,23],'m',[4,21],'l',[4,0]]},
	...
	'Ã': {w:22,n:7,d:['m',[10,23],'l',[13,25],'m',[4,21],'l',[4,6],'q',[4,0],[11,0],'q',[18,0],[18,6],'l',[18,21]]},
	'Ã': {w:22,n:7,d:['m',[9,23],'l',[11,25],[13,23],'m',[4,21],'l',[4,6],'q',[4,0],[11,0],'q',[18,0],[18,6],'l',[18,21]]},
	'Ã': {w:22,n:9,d:['m',[7,25],'l',[7,23],'m',[15,25],'l',[15,23],'m',[4,21],'l',[4,6],'q',[4,0],[11,0],'q',[18,0],[18,6],'l',[18,21]]},
	'Ã': {w:18,n:6,d:['m',[8,23],'l',[11,25],'m',[1,21],'l',[9,11],[9,0],'m',[17,21],'l',[9,11]]},
	'Ã': {w:19,n:7,d:['m',[4,18],'l',[4,-5],'m',[4,14],'l',[9,14],'q',[16,14],[16,7],'q',[16,0],[9,0],'l',[4,0]]},
	'Ã': {w:21,n:9,d:['m',[8,0],'l',[11,0],'q',[17,0],[17,5],'l',[17,6],'q',[17,10],[11,12],'q',[16,13],[16,16],'q',[16,21],[10,21],'q',[4,21],[4,16],'l',[4,0]]},
